function output=CoreFHorzExpAssetU_nod1_noz_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% n_d=n_d_withoutd1;
...
FnsToEvaluate.assets=@(d2,a1prime,a1,a2) a1;
FnsToEvaluate.humancapital=@(d2,a1prime,a1,a2) a2;
