function output=CoreFHorzExpAssetU_nod1_z_noe_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAsset noa1: no d1, z, no e. Experience asset is the only endogenous state.
...
title('Age-conditional assets (z, noa1)')
