function output=CoreFHorzExpAssetU_nod1_noz_noe_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAsset noa1: no d1, no z, no e. Experience asset is the only endogenous state.
...
FnsToEvaluate.assets=@(d2,a) a;
FnsToEvaluate.earnings=@(d2,a,w,kappa_j) w*kappa_j*d2*a;
...
title('Age-conditional assets (plain, noa1)')
