function output=CoreFHorzExpAssetU_d1_noz_e_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAsset noa1: with d1 (labour), no z, e. Experience asset is the only endogenous state.
...
FnsToEvaluate.assets=@(d1,d2,a,e) a;
FnsToEvaluate.earnings=@(d1,d2,a,e,w,kappa_j) w*kappa_j*d1*d2*a*e;
...
title('Age-conditional assets (d1+e, noa1)')
