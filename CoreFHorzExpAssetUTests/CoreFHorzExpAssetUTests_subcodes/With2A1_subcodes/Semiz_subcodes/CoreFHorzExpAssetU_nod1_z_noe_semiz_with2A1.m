function output=CoreFHorzExpAssetU_nod1_z_noe_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,r2,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_z_noe_semiz_with2A1(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,r2,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
