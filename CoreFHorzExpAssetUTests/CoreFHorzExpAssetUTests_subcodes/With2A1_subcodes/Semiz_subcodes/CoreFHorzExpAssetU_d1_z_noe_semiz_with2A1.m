function output=CoreFHorzExpAssetU_d1_z_noe_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
jequaloneDist(1,1,2,ceil(vfoptions.n_semiz/2),ceil(n_z/2))=1;

ReturnFn=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_z_noe_semiz_with2A1(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);
...
%%
clear V3 V4 V3B V4B V4C Policy3 Policy4 Policy3B Policy4B Policy4C PolicyVals3 V3fromPolicy
...
jequaloneDist5(1,1,2,ceil(vfoptions.n_semiz/2),ceil(n_z/2))=1;
