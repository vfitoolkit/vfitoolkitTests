function output=CoreFHorzExpAssetU_d1_noz_e_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
jequaloneDist(1,1,2,ceil(vfoptions.n_semiz/2),ceil(vfoptions.n_e/2))=1;

ReturnFn=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_e_semiz_with2A1(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e) a1;
FnsToEvaluate.assets2=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e) a1_2;
FnsToEvaluate.humancapital=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e) a2;
FnsToEvaluate.earnings=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e,w,kappa_j) w*kappa_j*d1*d2*a2*semiz*e;
...
jequaloneDist5=zeros([n_a,vfoptions.n_semiz,vfoptions.n_e],'gpuArray'); % small-grid init for Policy5
jequaloneDist5(1,1,2,ceil(vfoptions.n_semiz/2),ceil(vfoptions.n_e/2))=1;
