function output=CoreFHorzExpAssetU_nod1_noz_noe_nosemiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% n_d=n_d_withoutd1;
% d_grid=d_grid_withoutd1;
...
FnsToEvaluate.assets=@(d2,a1prime,a1_2prime,a1,a1_2,a2) a1;
FnsToEvaluate.assets2=@(d2,a1prime,a1_2prime,a1,a1_2,a2) a1_2;
FnsToEvaluate.humancapital=@(d2,a1prime,a1_2prime,a1,a1_2,a2) a2;
FnsToEvaluate.earnings=@(d2,a1prime,a1_2prime,a1,a1_2,a2,w,kappa_j) w*kappa_j*d2*a2;
