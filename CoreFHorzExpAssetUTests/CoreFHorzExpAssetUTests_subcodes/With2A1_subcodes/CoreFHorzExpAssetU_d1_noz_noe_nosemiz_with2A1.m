function output=CoreFHorzExpAssetU_d1_noz_noe_nosemiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% n_d=n_d_withd1;
...
jequaloneDist=zeros(n_a_big,'gpuArray'); % Note: based on n_a_big, not n_a
jequaloneDist(1,1)=1;

ReturnFn=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_d1_noz_noe_nosemiz_with2A1(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2) a1;
FnsToEvaluate.assets2=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2) a1_2;
FnsToEvaluate.humancapital=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2) a2;
FnsToEvaluate.earnings=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,w,kappa_j) w*kappa_j*d1*d2*a2;
...
jequaloneDist5=zeros(n_a,'gpuArray'); % small-grid init for Policy5
