function output=CoreFHorzExpAssetU_d1_noz_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% n_d=n_d_withd1;
...
FnsToEvaluate.assets=@(d1,d2,a1prime,a1,a2) a1;
FnsToEvaluate.humancapital=@(d1,d2,a1prime,a1,a2) a2;
