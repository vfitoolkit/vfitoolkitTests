function output=CoreFHorzQHExpAssetU_d1_z_e_noa1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetu, noa1 + semiz: with d1 (labour), z, e.
...
% (The baseline is pending too: ExpAssetU+SemiExo without a standard asset is not
