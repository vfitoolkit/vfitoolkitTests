function output=CoreFHorzQHExpAssetU_nod1_noz_e_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetu, single standard endogenous asset a1: no d1, no z, e.
...
% shocks: {e (iid)} -> valid lowmemory {0,1}.
%
...
ReturnFn=@(d2,a1prime,a1,a2,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_nod1_noz_e_nosemiz(d2,a1prime,a1,a2,e,r,w,kappa_j,sigma,agej,Jr,pension);
