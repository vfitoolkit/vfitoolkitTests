function output=CoreFHorzQHExpAssetU_d1_z_e_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetu + semiz with TWO standard endogenous assets -> triggers the
...
% the calling test script (CoreFHorzExpAssetU_setup), exactly as for the baseline counterpart.
%
