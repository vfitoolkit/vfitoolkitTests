function output=CoreFHorzQHExpAssetU_d1_noz_e_nosemiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetu with TWO standard endogenous assets -> triggers the
...
% a = [a1 (standard), a1_2 (standard), a2 (experience asset)]. n_d=[n_d1,n_d2]; d_grid=[d1_grid; d2_grid]
