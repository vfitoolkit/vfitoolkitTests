function F=ReturnFn_ExpAssetsemiz_nod1_noz_noe_noa1(d2,d3,a,semiz,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost)
...
if agej<Jr
    c=w*kappa_j*d2*a*semiz+uempbenefit*(1-semiz);
else
    c=pension;
end
