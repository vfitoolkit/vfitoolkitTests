function output=CoreFHorzExpAssetsemiz_d1_noz_noe_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% experienceassetsemiz with TWO standard endogenous assets. semiz always present. No ordinary z, no e.
...
% zeros assets, mid point for semiz
jequaloneDist=zeros([n_a_big,vfoptions.n_semiz],'gpuArray'); % Note: based on n_a_big, not n_a
jequaloneDist(1,1,1,ceil(vfoptions.n_semiz/2))=1;

ReturnFn=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetsemiz_d1_noz_noe_with2A1(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz) a1;
FnsToEvaluate.assets2=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz) a1_2;
FnsToEvaluate.humancapital=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz) a2;
FnsToEvaluate.earnings=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,w,kappa_j) w*kappa_j*d1*d2*a2*semiz;
...
title('Earnings Mean (experienceassetsemiz, with2A1, d1, noz, noe)')
legend('1','3')
