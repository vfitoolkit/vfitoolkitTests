function output=CoreFHorzExpAssetsemiz_nod1_noz_noe_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,r,r2,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetsemiz_nod1_noz_noe_with2A1(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,r,r2,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz) a1;
FnsToEvaluate.assets2=@(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz) a1_2;
FnsToEvaluate.humancapital=@(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz) a2;
FnsToEvaluate.earnings=@(d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,w,kappa_j) w*kappa_j*d2*a2*semiz;
...
title('Earnings Mean (experienceassetsemiz, with2A1, nod1, noz, noe)')
legend('1','3')
