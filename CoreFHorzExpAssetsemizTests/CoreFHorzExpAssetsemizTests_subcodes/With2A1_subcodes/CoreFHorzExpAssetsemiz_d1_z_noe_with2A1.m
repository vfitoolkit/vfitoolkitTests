function output=CoreFHorzExpAssetsemiz_d1_z_noe_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% experienceassetsemiz with TWO standard endogenous assets. semiz always present. With ordinary z, no e.
...
% zeros assets, mid points for semiz and z (bothz ordering: [semiz,z])
jequaloneDist=zeros([n_a_big,vfoptions.n_semiz,n_z],'gpuArray'); % Note: based on n_a_big, not n_a
jequaloneDist(1,1,1,ceil(vfoptions.n_semiz/2),ceil(n_z/2))=1;

ReturnFn=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetsemiz_d1_z_noe_with2A1(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) a1;
FnsToEvaluate.assets2=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) a1_2;
FnsToEvaluate.humancapital=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) a2;
FnsToEvaluate.earnings=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,w,kappa_j) w*kappa_j*d1*d2*a2*semiz*z;
...
%%
clear V1 V2 V1B V1C V2B V2C Policy1 Policy2 Policy1B Policy1C Policy2B Policy2C PolicyVals1 V1fromPolicy
...
%%
clear V3 V4 V3B V3C V4B V4C Policy3 Policy4 Policy3B Policy3C Policy4B Policy4C PolicyVals3 V3fromPolicy
...
title('Earnings Mean (experienceassetsemiz, with2A1, d1, z, noe)')
legend('1','3')
