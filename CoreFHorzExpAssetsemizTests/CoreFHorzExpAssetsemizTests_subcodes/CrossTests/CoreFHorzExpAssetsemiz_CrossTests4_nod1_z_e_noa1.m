function output=CoreFHorzExpAssetsemiz_CrossTests4_nod1_z_e_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 4 (nod1, z, e): noa1 ExpAssetsemiz vs a1=1 degenerate ExpAssetsemiz.
...
%% (semiz, z, e)
ReturnFn_A=@(d2,d3,a,semiz,z,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetsemiz_nod1_z_e_noa1(d2,d3,a,semiz,z,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_B=@(d2,d3,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetsemiz_nod1_z_e_noa1(d2,d3,a2,semiz,z,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
...
FnsA.humancapital=@(d2,d3,a,semiz,z,e) a;
FnsB.humancapital=@(d2,d3,a1prime,a1,a2,semiz,z,e) a2;
