...
fprintf('Cross test 4 (noa1 vs a1=1, nod1 semiz noz e): sim panel means should roughly match: %2.8f vs %2.8f \n',mean(SimPanel_A.humancapital,'all'),mean(SimPanel_B.humancapital,'all'))
