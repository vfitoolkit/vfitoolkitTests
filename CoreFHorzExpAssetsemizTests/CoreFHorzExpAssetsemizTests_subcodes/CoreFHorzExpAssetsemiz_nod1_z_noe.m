function output=CoreFHorzExpAssetsemiz_nod1_z_noe(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% experienceassetsemiz: aprime depends on (d2,a2,semiz). semiz always present. With ordinary z, no e.
...
title('Earnings Mean (experienceassetsemiz, nod1, z, noe)')
legend('1','3')
