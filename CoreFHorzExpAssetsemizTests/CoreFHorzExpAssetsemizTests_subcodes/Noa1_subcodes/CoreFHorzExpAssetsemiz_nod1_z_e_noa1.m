function output=CoreFHorzExpAssetsemiz_nod1_z_e_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% experienceassetsemiz noa1: aprime depends on (d2,a2,semiz). semiz always present. With ordinary z, with e.
...
% zero experience asset, mid points for semiz, z and e (bothz ordering: [semiz,z], then e)
...
FnsToEvaluate.humancapital=@(d2,d3,a,semiz,z,e) a;
FnsToEvaluate.earnings=@(d2,d3,a,semiz,z,e,w,kappa_j) w*kappa_j*d2*a*semiz*z*e;
...
title('Age-conditional human capital (experienceassetsemiz, noa1, nod1, z, e)')
