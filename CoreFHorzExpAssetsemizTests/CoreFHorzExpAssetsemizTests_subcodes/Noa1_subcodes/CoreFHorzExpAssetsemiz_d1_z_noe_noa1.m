function output=CoreFHorzExpAssetsemiz_d1_z_noe_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
FnsToEvaluate.humancapital=@(d1,d2,d3,a,semiz,z) a;
...
fprintf('noa1 moments (semiz, z, noe; d1)\n')
...
title('Age-conditional human capital (experienceassetsemiz, noa1, d1, z, noe)')
