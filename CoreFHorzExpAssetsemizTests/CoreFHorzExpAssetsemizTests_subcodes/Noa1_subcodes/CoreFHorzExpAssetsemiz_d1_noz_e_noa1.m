function output=CoreFHorzExpAssetsemiz_d1_noz_e_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% experienceassetsemiz noa1: aprime depends on (d2,a2,semiz). semiz always present. No ordinary z, with e.
...
% zero experience asset, mid points for semiz and e
...
FnsToEvaluate.humancapital=@(d1,d2,d3,a,semiz,e) a;
FnsToEvaluate.earnings=@(d1,d2,d3,a,semiz,e,w,kappa_j) w*kappa_j*d1*d2*a*semiz*e;
...
fprintf('noa1 moments (semiz, noz, e; d1)\n')
...
title('Age-conditional human capital (experienceassetsemiz, noa1, d1, noz, e)')
