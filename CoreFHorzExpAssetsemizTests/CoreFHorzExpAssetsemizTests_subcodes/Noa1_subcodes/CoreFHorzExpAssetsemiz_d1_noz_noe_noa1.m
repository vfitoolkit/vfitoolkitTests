function output=CoreFHorzExpAssetsemiz_d1_noz_noe_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d1,d2,d3,a,semiz,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetsemiz_d1_noz_noe_noa1(d1,d2,d3,a,semiz,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);

% Setup some FnsToEvaluate
FnsToEvaluate.humancapital=@(d1,d2,d3,a,semiz) a;
...
fprintf('noa1 moments (semiz, noz, noe; d1)\n')
...
title('Age-conditional human capital (experienceassetsemiz, noa1, d1, noz, noe)')
