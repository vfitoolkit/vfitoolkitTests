function output=CoreFHorzExpAssetsemiz_nod1_noz_e_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
FnsToEvaluate.humancapital=@(d2,d3,a,semiz,e) a;
FnsToEvaluate.earnings=@(d2,d3,a,semiz,e,w,kappa_j) w*kappa_j*d2*a*semiz*e;
...
fprintf('noa1 moments (semiz, noz, e)\n')
...
title('Age-conditional human capital (experienceassetsemiz, noa1, nod1, noz, e)')
