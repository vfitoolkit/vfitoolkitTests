function output=CoreFHorzExpAssetsemiz_d1_noz_noe(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% experienceassetsemiz: aprime depends on (d2,a2,semiz). semiz always present. With d1, no ordinary z, no e.
...
FnsToEvaluate.assets=@(d1,d2,d3,a1prime,a1,a2,semiz) a1;
FnsToEvaluate.humancapital=@(d1,d2,d3,a1prime,a1,a2,semiz) a2;
FnsToEvaluate.earnings=@(d1,d2,d3,a1prime,a1,a2,semiz,w,kappa_j) w*kappa_j*d1*d2*a2*semiz;
...
title('Earnings Mean (experienceassetsemiz, d1, noz, noe)')
legend('1','3')
