function output=CoreInfHorzTPathAlgo_nod_z_noe_nosemiz_with2A(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,n_d_GE,n_a_GE,d_grid_GE,a_grid_GE,figure_c)
...
% The model and its stationary general eqm are lifted from CoreInfHorzTPath_nod_z_noe_nosemiz_with2A.
