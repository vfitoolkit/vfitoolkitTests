function nhired=EntreHiredLabour_nod_with2A(aprime,eprime,a,e,eta,theta,r,w,delta,upsilon1,upsilon2,leverage,phi)
% Note: aprime and eprime are unused here, but the toolkit convention is that the function
