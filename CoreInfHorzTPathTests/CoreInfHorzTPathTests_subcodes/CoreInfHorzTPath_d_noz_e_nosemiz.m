function output=CoreInfHorzTPath_d_noz_e_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,n_d_GE,n_a_GE,d_grid_GE,a_grid_GE,figure_c)
...
FnsToEvaluate.nextassets=@(d,aprime,a,e) aprime; % aprime-dependent, so it tests the policy decode directly
FnsToEvaluate.eval=@(d,aprime,a,e) e; % the iid shock itself
...
FnsToEvaluateGE.K=@(d,aprime,a,e) a;
FnsToEvaluateGE.N=@(d,aprime,a,e) d*e;
