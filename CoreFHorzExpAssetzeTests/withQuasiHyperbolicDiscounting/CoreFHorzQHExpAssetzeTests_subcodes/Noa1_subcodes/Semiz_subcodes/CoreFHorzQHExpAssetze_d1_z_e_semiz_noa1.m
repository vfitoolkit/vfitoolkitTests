...
fprintf('Naive lowmemory=3, this should be zero: %.3e \n',max(abs(V1(:)-V1D(:))))
fprintf('Naive lowmemory=3 (Valt), this should be zero: %.3e \n',max(abs(V1alt(:)-V1Dalt(:))))
fprintf('Naive lowmemory=3 (Policy), this should be zero: %.3e \n',max(abs(Policy1(:)-Policy1D(:))))
...
fprintf('Sophisticated lowmemory=3, this should be zero: %.3e \n',max(abs(V1s(:)-V1sD(:))))
fprintf('Sophisticated lowmemory=3 (Valt), this should be zero: %.3e \n',max(abs(V1salt(:)-V1sDalt(:))))
fprintf('Sophisticated lowmemory=3 (Policy), this should be zero: %.3e \n',max(abs(Policy1s(:)-Policy1sD(:))))
vfoptions1.lowmemory=0;
