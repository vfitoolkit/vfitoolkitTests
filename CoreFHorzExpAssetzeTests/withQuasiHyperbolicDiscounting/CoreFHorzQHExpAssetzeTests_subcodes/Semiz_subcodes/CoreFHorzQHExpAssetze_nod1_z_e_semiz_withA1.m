...
for qhcase=1:2
    ...
    if qhcase==1, fprintf('%s DC1 (Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy1alt(:)-Policy2alt(:)))); end
    ...
    if qhcase==1, fprintf('%s lowmemory=1 (DC1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy2alt(:)-Policy2Balt(:)))); end
    ...
    if qhcase==1, fprintf('%s lowmemory=2 (DC1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy2alt(:)-Policy2Calt(:)))); end
    ...
    fprintf('%s lowmemory=3 (DC1), this should be zero: %2.8f \n',qh,max(abs(V2(:)-V2D(:))))
    fprintf('%s lowmemory=3 (DC1, Valt), this should be zero: %2.8f \n',qh,max(abs(V2alt(:)-V2Dalt(:))))
    fprintf('%s lowmemory=3 (DC1, Policy), this should be zero: %2.8f \n',qh,max(abs(Policy2(:)-Policy2D(:))))
    if qhcase==1, fprintf('%s lowmemory=3 (DC1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy2alt(:)-Policy2Dalt(:)))); end
    ...
    if qhcase==1, fprintf('%s lowmemory=1 (GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy3alt(:)-Policy3Balt(:)))); end
    ...
    if qhcase==1, fprintf('%s lowmemory=2 (GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy3alt(:)-Policy3Calt(:)))); end
    ...
    fprintf('%s lowmemory=3 (GI1), this should be zero: %2.8f \n',qh,max(abs(V3(:)-V3D(:))))
    fprintf('%s lowmemory=3 (GI1, Valt), this should be zero: %2.8f \n',qh,max(abs(V3alt(:)-V3Dalt(:))))
    fprintf('%s lowmemory=3 (GI1, Policy), this should be zero: %2.8f \n',qh,max(abs(Policy3(:)-Policy3D(:))))
    if qhcase==1, fprintf('%s lowmemory=3 (GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy3alt(:)-Policy3Dalt(:)))); end
    ...
    if qhcase==1, fprintf('%s DC1_GI1 vs GI1 (Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy3alt(:)-Policy4alt(:)))); end
    ...
    if qhcase==1, fprintf('%s lowmemory=1 (DC1_GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy4alt(:)-Policy4Balt(:)))); end
    ...
    if qhcase==1, fprintf('%s lowmemory=2 (DC1_GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy4alt(:)-Policy4Calt(:)))); end
    ...
    fprintf('%s lowmemory=3 (DC1_GI1), this should be zero: %2.8f \n',qh,max(abs(V4(:)-V4D(:))))
    fprintf('%s lowmemory=3 (DC1_GI1, Valt), this should be zero: %2.8f \n',qh,max(abs(V4alt(:)-V4Dalt(:))))
    fprintf('%s lowmemory=3 (DC1_GI1, Policy), this should be zero: %2.8f \n',qh,max(abs(Policy4(:)-Policy4D(:))))
    if qhcase==1, fprintf('%s lowmemory=3 (DC1_GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy4alt(:)-Policy4Dalt(:)))); end
