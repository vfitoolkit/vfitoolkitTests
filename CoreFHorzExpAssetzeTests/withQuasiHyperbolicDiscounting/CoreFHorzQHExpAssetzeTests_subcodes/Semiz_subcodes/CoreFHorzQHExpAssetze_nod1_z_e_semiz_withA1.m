...
fprintf('%s lowmemory=3 (DC1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy2alt(:)-Policy2Dalt(:))));
...
fprintf('%s lowmemory=3 (GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy3alt(:)-Policy3Dalt(:))));
...
fprintf('%s lowmemory=3 (DC1_GI1, Policyalt), this should be zero: %2.8f \n',qh,max(abs(Policy4alt(:)-Policy4Dalt(:))));
