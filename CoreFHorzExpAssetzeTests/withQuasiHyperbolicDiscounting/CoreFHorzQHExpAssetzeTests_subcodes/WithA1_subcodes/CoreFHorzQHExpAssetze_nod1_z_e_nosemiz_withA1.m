...
% Quasi-hyperbolic experienceassetze, single standard endogenous asset a1.
% NOTE: QH+experienceassetze supports the BASELINE only for a single a1 (there are no DC1/GI1
% QH-ExpAssetze raws; DC/GI require two standard assets -- see the _with2A1 subcodes).
