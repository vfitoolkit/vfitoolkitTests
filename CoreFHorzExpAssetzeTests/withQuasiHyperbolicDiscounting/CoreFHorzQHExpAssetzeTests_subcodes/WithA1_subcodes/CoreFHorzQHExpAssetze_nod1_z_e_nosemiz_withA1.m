function output=CoreFHorzQHExpAssetze_nod1_z_e_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetze, single standard endogenous asset a1: no d1, z, e.
...
% shocks: {z (markov), e (iid)} -> valid lowmemory {0,1,2}. Note that experienceassetze has
% exactly one e: it is structural in aprimeFn(d2,a2,z,e) AND the value function's iid shock.
