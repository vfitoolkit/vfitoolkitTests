function F=ReturnFn_ExpAssetze_nod1_z_e_with2A1(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e,r,r2,w,kappa_j,sigma,agej,Jr,pension)
...
if agej<Jr
    c=(1+r)*a1+(1+r2)*a1_2+w*kappa_j*d2*a2*z*e-a1prime-a1_2prime;
else
