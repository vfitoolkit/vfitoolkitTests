function output=CoreFHorzExpAssetze_nod1_z_e_nosemiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
% asset (return r2>r, holdings in {0,1}). The experienceassetze a2 is unchanged.
...
ReturnFn=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e,r,r2,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetze_nod1_z_e_with2A1(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e,r,r2,w,kappa_j,sigma,agej,Jr,pension);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e) a1;
FnsToEvaluate.assets2=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e) a1_2;
FnsToEvaluate.humancapital=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e) a2;
FnsToEvaluate.earnings=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e,w,kappa_j) w*kappa_j*d2*a2*z*e;
