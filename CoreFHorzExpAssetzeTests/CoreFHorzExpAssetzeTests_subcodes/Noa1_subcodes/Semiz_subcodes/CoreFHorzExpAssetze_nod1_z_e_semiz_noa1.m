function output=CoreFHorzExpAssetze_nod1_z_e_semiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssetze noa1 + semiz: no d1, z, e. Experience asset a2 is the only endogenous state.
...
FnsToEvaluate.assets=@(d2,d3,a2,semiz,z,e) a2;
FnsToEvaluate.earnings=@(d2,d3,a2,semiz,z,e,w,kappa_j) w*kappa_j*d2*a2*semiz*z*e;
