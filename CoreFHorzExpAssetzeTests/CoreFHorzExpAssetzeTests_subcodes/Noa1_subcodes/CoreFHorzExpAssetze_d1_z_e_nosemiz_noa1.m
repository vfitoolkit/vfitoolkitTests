function output=CoreFHorzExpAssetze_d1_z_e_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssetze noa1: with d1 (labour), z, e. Experience asset a2 is the only endogenous state.
...
FnsToEvaluate.assets=@(d1,d2,a2,z,e) a2;
FnsToEvaluate.earnings=@(d1,d2,a2,z,e,w,kappa_j) w*kappa_j*d1*d2*a2*z*e;
...
title('Age-conditional assets (d1+z+e, noa1)')
