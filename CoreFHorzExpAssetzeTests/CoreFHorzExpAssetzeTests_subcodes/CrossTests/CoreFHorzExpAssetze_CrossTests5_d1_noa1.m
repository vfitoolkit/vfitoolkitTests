function output=CoreFHorzExpAssetze_CrossTests5_d1_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 5 (d1, nosemiz): noa1 ExpAssetze vs a1=1 degenerate ExpAssetze.
...
%% z, e
ReturnFn_A=@(d1,d2,a2,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssetze_d1_z_e_noa1(d1,d2,a2,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
ReturnFn_B=@(d1,d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssetze_d1_z_e_noa1(d1,d2,a2,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
...
fprintf('Cross test 5 (noa1 vs a1=1, d1 z e): sim panel means should roughly match: %2.8f vs %2.8f \n',mean(SimPanel_A.assets,'all'),mean(SimPanel_B.assets,'all'))
