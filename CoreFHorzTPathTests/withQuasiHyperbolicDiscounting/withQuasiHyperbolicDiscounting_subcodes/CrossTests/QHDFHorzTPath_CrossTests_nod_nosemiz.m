function output=QHDFHorzTPath_CrossTests_nod_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline)
...
for qhregime={'Naive','Sophisticated'}
    qh=qhregime{1};
    fprintf('\n--- QH-TPath CrossTests (nod, nosemiz): %s ---\n',qh)
