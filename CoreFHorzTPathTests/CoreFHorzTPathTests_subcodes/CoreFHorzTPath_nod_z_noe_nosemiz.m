function output=CoreFHorzTPath_nod_z_noe_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
Policy_final_GI=ones([2,n_a,n_z,N_j],'gpuArray');
% need big versions
V_final_big=zeros([n_a_big,n_z,N_j],'gpuArray');
Policy_final_big=ones([1,n_a_big,n_z,N_j],'gpuArray');
Policy_final_big_GI=ones([2,n_a_big,n_z,N_j],'gpuArray');
