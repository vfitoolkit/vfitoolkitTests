function output=CoreFHorzTPath_nod1_z_e_semiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,figure_c)


% n_d is n_d2_semiz, d_grid is d2_grid_semiz: just the binary d2 that drives the semi-exogenous state
...
jequaloneDist_big=zeros([n_a_big,vfoptions.n_semiz,n_z,vfoptions.n_e],'gpuArray'); % Note: based on n_a_big
jequaloneDist_big(1,ceil(vfoptions.n_semiz/2),ceil(n_z/2),ceil(vfoptions.n_e/2))=1;
jequaloneDist=zeros([n_a,vfoptions.n_semiz,n_z,vfoptions.n_e],'gpuArray'); % Note: based on n_a
...
V_final=zeros([n_a,vfoptions.n_semiz,n_z,vfoptions.n_e,N_j],'gpuArray');
Policy_final=ones([2,n_a,vfoptions.n_semiz,n_z,vfoptions.n_e,N_j],'gpuArray');
Policy_final_GI=ones([4,n_a,vfoptions.n_semiz,n_z,vfoptions.n_e,N_j],'gpuArray');
% big versions of them
V_final_big=zeros([n_a_big,vfoptions.n_semiz,n_z,vfoptions.n_e,N_j],'gpuArray');
Policy_final_big=ones([2,n_a_big,vfoptions.n_semiz,n_z,vfoptions.n_e,N_j],'gpuArray');
Policy_final_big_GI=ones([4,n_a_big,vfoptions.n_semiz,n_z,vfoptions.n_e,N_j],'gpuArray');
