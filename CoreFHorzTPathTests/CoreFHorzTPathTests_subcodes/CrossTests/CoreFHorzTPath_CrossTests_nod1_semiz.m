function output=CoreFHorzTPath_CrossTests_nod1_semiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline)
% TPath version of CoreFHorz_CrossTests_nod1_semiz: each ValueFnIter+StationaryDist
...
% n_d=n_d2_semiz;  d_grid=d2_grid_semiz; (just the binary d2 that drives the semi-exo state)
...
Policy_final0=ones([2,n_a,n_semiz,N_j],'gpuArray');
...
Policy_final0z=ones([2,n_a,n_semiz,1,N_j],'gpuArray');
...
Policy_final1=ones([2,n_a,n_semiz,n_z,N_j],'gpuArray');
...
Policy_final2=ones([2,n_a,n_semiz,vfoptionsB.n_e,N_j],'gpuArray');
...
Policy_final3=ones([2,n_a,n_semiz,1,vfoptionsB.n_e,N_j],'gpuArray');
...
Policy_final4=ones([2,n_a,n_semiz,n_z,1,N_j],'gpuArray');
