...
fprintf('lowmemory=3 (Valt, Naive), this should be zero: %.3e \n',max(abs(V1alt(:)-V1Dalt(:))))
vfoptions1.lowmemory=0;
...
fprintf('lowmemory=3 (with DC) (Valt, Naive), this should be zero: %.3e \n',max(abs(V2alt(:)-V2Dalt(:))))
vfoptions2.lowmemory=0;
...
fprintf('lowmemory=3 (with GI) (Valt, Naive), this should be zero: %.3e \n',max(abs(V3alt(:)-V3Dalt(:))))
vfoptions3.lowmemory=0;
...
fprintf('lowmemory=3  (with DC+GI) (Valt, Naive), this should be zero: %.3e \n',max(abs(V4alt(:)-V4Dalt(:))))
vfoptions4.lowmemory=0;
...
fprintf('lowmemory=3, this should be zero: %.3e \n',max(abs(V1(:)-V1D(:))))
fprintf('lowmemory=3, this should be zero: %.3e \n',max(abs(Policy1(:)-Policy1D(:))))
fprintf('lowmemory=3 (Valt, Sophisticated), this should be zero: %.3e \n',max(abs(V1alt(:)-V1Dalt(:))))
vfoptions1.lowmemory=0;
...
fprintf('lowmemory=3 (with DC), this should be zero: %.3e \n',max(abs(V2(:)-V2D(:))))
fprintf('lowmemory=3 (with DC), this should be zero: %.3e \n',max(abs(Policy2(:)-Policy2D(:))))
fprintf('lowmemory=3 (with DC) (Valt, Sophisticated), this should be zero: %.3e \n',max(abs(V2alt(:)-V2Dalt(:))))
vfoptions2.lowmemory=0;
...
fprintf('lowmemory=3 (with GI), this should be zero: %.3e \n',max(abs(V3(:)-V3D(:))))
fprintf('lowmemory=3 (with GI), this should be zero: %.3e \n',max(abs(Policy3(:)-Policy3D(:))))
fprintf('lowmemory=3 (with GI) (Valt, Sophisticated), this should be zero: %.3e \n',max(abs(V3alt(:)-V3Dalt(:))))
vfoptions3.lowmemory=0;
...
fprintf('lowmemory=3  (with DC+GI), this should be zero: %.3e \n',max(abs(V4(:)-V4D(:))))
fprintf('lowmemory=3  (with DC+GI), this should be zero: %.3e \n',max(abs(Policy4(:)-Policy4D(:))))
fprintf('lowmemory=3  (with DC+GI) (Valt, Sophisticated), this should be zero: %.3e \n',max(abs(V4alt(:)-V4Dalt(:))))
vfoptions4.lowmemory=0;
...
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Naive), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive, Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Naive (with DC)), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive (with DC)), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive (with DC), Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Naive (with GI)), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive (with GI)), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive (with GI), Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Naive (with DC+GI)), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive (with DC+GI)), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Naive (with DC+GI), Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Sophisticated), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated, Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with DC)), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with DC)), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with DC), Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with GI)), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with GI)), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with GI), Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
...
vfoptionsjs.lowmemory=3;
[Vshort,Policyshort,Valtshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with DC+GI)), this should be zero: %.3e \n',max(abs(Vbase(:)-Vshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with DC+GI)), this should be zero: %.3e \n',max(abs(Policybase(:)-Policyshort(:))))
fprintf('V_Jplus1, lowmemory=3 (Sophisticated (with DC+GI), Valt), this should be zero: %.3e \n',max(abs(Valtbase(:)-Valtshort(:))))
vfoptionsjs.lowmemory=0;
