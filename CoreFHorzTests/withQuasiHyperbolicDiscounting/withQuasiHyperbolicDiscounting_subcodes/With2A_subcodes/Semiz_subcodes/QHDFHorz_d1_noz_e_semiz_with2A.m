function output=QHDFHorz_d1_noz_e_semiz_with2A(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d1,d2,a1prime,a2prime,a1,a2,semiz,e,r,w,kappa_j,sigma,agej,Jr,pension,eta,varphi,uempbenefit,searcheffortcost,phi1,phi2) ReturnFn_d1_noz_e_semiz_with2A(d1,d2,a1prime,a2prime,a1,a2,semiz,e,r,w,kappa_j,sigma,agej,Jr,pension,eta,varphi,uempbenefit,searcheffortcost,phi1,phi2);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,a1prime,a2prime,a1,a2,semiz,e) a1;
FnsToEvaluate.house=@(d1,d2,a1prime,a2prime,a1,a2,semiz,e) a2;
FnsToEvaluate.earnings=@(d1,d2,a1prime,a2prime,a1,a2,semiz,e,w,kappa_j) w*kappa_j*d1*semiz*e;
