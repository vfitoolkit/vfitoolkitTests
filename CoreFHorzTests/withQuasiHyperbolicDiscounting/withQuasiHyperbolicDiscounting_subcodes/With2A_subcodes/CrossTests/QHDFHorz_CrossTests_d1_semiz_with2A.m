function output=QHDFHorz_CrossTests_d1_semiz_with2A(n_d_semiz,n_d2_semiz,n_a,n_a_big,n_z,N_j,d_grid_semiz,d2_grid_semiz,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
...
vfopts.exoticpreferences='QuasiHyperbolic';
vfopts.QHadditionaldiscount=vfoptionsbaseline.QHadditionaldiscount;
vfopts.quasi_hyperbolic='Naive';

% with-d1 ReturnFn (d1 in signature but ignored)
ReturnFn_d1=@(d1,d2,a1prime,a2prime,a1,a2,semiz,r,w,kappa_j,sigma,agej,Jr,pension,eta,varphi,uempbenefit,searcheffortcost,phi1,phi2) ReturnFn_d1_noz_noe_semiz_test6_with2A(d1,d2,a1prime,a2prime,a1,a2,semiz,r,w,kappa_j,sigma,agej,Jr,pension,eta,varphi,uempbenefit,searcheffortcost,phi1,phi2);
...
vfopts.exoticpreferences='QuasiHyperbolic';
vfopts.QHadditionaldiscount=vfoptionsbaseline.QHadditionaldiscount;
vfopts.quasi_hyperbolic='Sophisticated';
