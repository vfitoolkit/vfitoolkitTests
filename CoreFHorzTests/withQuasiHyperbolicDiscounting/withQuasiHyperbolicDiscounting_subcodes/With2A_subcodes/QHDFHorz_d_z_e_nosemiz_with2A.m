function output=QHDFHorz_d_z_e_nosemiz_with2A(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
jequaloneDist(1,1,ceil(n_z/2),ceil(vfoptions.n_e/2))=1; % no assets, midpoint shock

ReturnFn=@(d,a1prime,a2prime,a1,a2,z,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,phi1,phi2) ReturnFn_d_z_e_nosemiz_with2A(d,a1prime,a2prime,a1,a2,z,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,phi1,phi2);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d,a1prime,a2prime,a1,a2,z,e) a1;
FnsToEvaluate.house=@(d,a1prime,a2prime,a1,a2,z,e) a2;
FnsToEvaluate.earnings=@(d,a1prime,a2prime,a1,a2,z,e,w,kappa_j) w*kappa_j*z*e*d;
