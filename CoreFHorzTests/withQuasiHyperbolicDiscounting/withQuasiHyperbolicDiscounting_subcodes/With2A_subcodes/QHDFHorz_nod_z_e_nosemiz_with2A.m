function output=QHDFHorz_nod_z_e_nosemiz_with2A(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(a1prime,a2prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension,phi1,phi2) ReturnFn_nod_z_e_nosemiz_with2A(a1prime,a2prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension,phi1,phi2);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(a1prime,a2prime,a1,a2,z,e) a1;
FnsToEvaluate.house=@(a1prime,a2prime,a1,a2,z,e) a2;
FnsToEvaluate.earnings=@(a1prime,a2prime,a1,a2,z,e,w,kappa_j) w*kappa_j*z*e;
