function F=ReturnFn_d_noz_noe_nosemiz_with2A(d,a1prime,a2prime,a1,a2,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,phi1,phi2)

F=-Inf;

if agej<Jr
    c=(1+r)*a1+w*kappa_j*d-a1prime+a2-a2prime;
else
