function output=CoreFHorz_nod_noz_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
% Note: this model has no shocks, so the cross-section at each age is degenerate: autocovariances
% should be (near) zero, and autocorrelations are 0/0=NaN in both (grid interp adds tiny noise)
