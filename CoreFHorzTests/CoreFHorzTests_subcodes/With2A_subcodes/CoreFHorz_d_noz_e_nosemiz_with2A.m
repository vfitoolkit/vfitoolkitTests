function output=CoreFHorz_d_noz_e_nosemiz_with2A(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d,a1prime,a2prime,a1,a2,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,phi1,phi2) ReturnFn_d_noz_e_nosemiz_with2A(d,a1prime,a2prime,a1,a2,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,phi1,phi2);
...
FnsToEvaluate.earnings=@(d,a1prime,a2prime,a1,a2,e,w,kappa_j) w*kappa_j*e*d;
