function output=EZFHorz_d_z_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_d_z_noe_nosemiz.m (which mirrors CoreFHorz_d_z_noe_nosemiz.m).
...
jequaloneDist(1,ceil(n_z/2))=1; % no assets, midpoint shock

ReturnFn_cons=@(d,aprime,a,z,r,w,kappa_j,varphi,agej,Jr,pension) EZReturnFn_cons_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_posU=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZReturnFn_positiveUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_negU=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZReturnFn_negativeUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
...
% consumption-units
ReturnFn_cons_scaled=@(d,aprime,a,z,r,w,kappa_j,varphi,agej,Jr,pension,ezscalefactor) ezscalefactor*EZReturnFn_cons_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_positiveUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_negativeUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
Params.ezphi=1/Params.ezgamma;
Params.ezsigma=Params.ezgamma;
ReturnFn_consWGoracle=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,beta,oneminussj,wg1,wg2) EZReturnFn_negativeUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension)+beta*oneminussj*((EZWarmGlowFn_cons(aprime,wg1,wg2)^(1-ezsigma))/(1-ezsigma));
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
ReturnFn_posUWGoracle=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negUWGoracle=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
% positive-valued utility fn
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
...
% consumption-units
ReturnFn_cons_scaled2=@(d,aprime,a,z,r,w,kappa_j,varphi,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_positiveUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_negativeUtils_d_z_noe_nosemiz(d,aprime,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
