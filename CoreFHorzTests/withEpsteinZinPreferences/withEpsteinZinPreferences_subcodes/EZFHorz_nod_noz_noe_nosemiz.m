function output=EZFHorz_nod_noz_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_nod_noz_noe_nosemiz.m (which mirrors CoreFHorz_nod_noz_noe_nosemiz.m).
...
ReturnFn_cons=@(aprime,a,r,w,kappa_j,agej,Jr,pension) EZReturnFn_cons_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,agej,Jr,pension);
ReturnFn_posU=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension) EZReturnFn_positiveUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_negU=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension) EZReturnFn_negativeUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(aprime,a) a;
FnsToEvaluate.earnings=@(aprime,a,w,kappa_j) w*kappa_j;
...
% consumption-units
ReturnFn_cons_scaled=@(aprime,a,r,w,kappa_j,agej,Jr,pension,ezscalefactor) ezscalefactor*EZReturnFn_cons_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_positiveUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_negativeUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
Params.ezphi=1/Params.ezgamma;
Params.ezsigma=Params.ezgamma;
ReturnFn_consWGoracle=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2) EZReturnFn_negativeUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*((EZWarmGlowFn_cons(aprime,wg1,wg2)^(1-ezsigma))/(1-ezsigma));
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
ReturnFn_posUWGoracle=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negUWGoracle=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
% positive-valued utility fn
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
...
% consumption-units
ReturnFn_cons_scaled2=@(aprime,a,r,w,kappa_j,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_positiveUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_negativeUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
for cc=2:length(ezgammavals)
    ...
    [V1a,Policy1a]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_cons,Params,DiscountFactorParamNames,[],vfoptions1);
    fprintf('No-shocks risk-aversion invariance, ezgamma=%g vs %g [EZ cons-units], V: this should be zero: %.3e \n',ezgammavals(cc),ezgammavals(1),max(abs(V1a(:)-Vref(:))))
    fprintf('No-shocks risk-aversion invariance, ezgamma=%g vs %g [EZ cons-units], Policy: this should be zero: %.3e \n',ezgammavals(cc),ezgammavals(1),max(abs(Policy1a(:)-Policyref(:))))
...
for ezcase=2:3
    ...
    for cc=2:length(ezriskvals)
        ...
        fprintf('No-shocks risk-aversion invariance, ezrisk=%g vs %g [EZ %s], V: this should be zero: %.3e \n',ezriskvals(cc),ezriskvals(1),casestr,max(abs(V1a(:)-Vref(:))))
        fprintf('No-shocks risk-aversion invariance, ezrisk=%g vs %g [EZ %s], Policy: this should be zero: %.3e \n',ezriskvals(cc),ezriskvals(1),casestr,max(abs(Policy1a(:)-Policyref(:))))
