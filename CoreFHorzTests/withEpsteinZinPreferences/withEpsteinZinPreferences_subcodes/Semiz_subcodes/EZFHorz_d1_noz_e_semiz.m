function output=EZFHorz_d1_noz_e_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_d1_noz_e_semiz.m (which mirrors CoreFHorz_d1_noz_e_semiz.m).
...
ReturnFn_cons=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost) EZReturnFn_cons_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_posU=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost) EZReturnFn_positiveUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_negU=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost) EZReturnFn_negativeUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,aprime,a,semiz,e) a;
FnsToEvaluate.earnings=@(d1,d2,aprime,a,semiz,e,w,kappa_j) w*kappa_j*e*d1*semiz;
...
% consumption-units
ReturnFn_cons_scaled=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZReturnFn_cons_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_cons_wgvnm=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2) EZReturnFn_negativeUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)+beta*oneminussj*((EZWarmGlowFn_cons(aprime,wg1,wg2)^(1-ezsigma))/(1-ezsigma));
ezphi_store=Params.ezphi;
ezsigma_store=Params.ezsigma;
Params.ezphi=1/Params.ezgamma;
Params.ezsigma=Params.ezgamma;
...
ReturnFn_posU_wgutil=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negU_wgutil=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
% positive-valued utility fn
vfoptions1=vfoptions;
...
% consumption-units
ReturnFn_cons_scaled2=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
