function output=EZFHorz_d1_z_e_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_d1_z_e_semiz.m (which mirrors CoreFHorz_d1_z_e_semiz.m).
...
jequaloneDist(1,ceil(vfoptions.n_semiz/2),ceil(n_z/2),ceil(vfoptions.n_e/2))=1; % no assets, midpoint shock

ReturnFn_cons=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost) EZReturnFn_cons_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_posU=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost) EZReturnFn_positiveUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_negU=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost) EZReturnFn_negativeUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
...
clear V1 V1B V1C V1D V2 V2B V2C V2D Policy1 Policy1B Policy1C Policy1D Policy2 Policy2B Policy2C Policy2D V1fromPolicy
...
clear V3 V3B V3C V3D V4 V4B V4C V4D Policy3 Policy3B Policy3C Policy3D Policy4 Policy4B Policy4C Policy4D V3fromPolicy
...
% consumption-units
ReturnFn_cons_scaled=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZReturnFn_cons_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZReturnFn_positiveUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZReturnFn_negativeUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
for ezcase=1:3
    ...
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=3 [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=3 [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Policybase(:)-Policyshort(:))))
    ...
    vfoptionsjs.lowmemory=3;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=3 (with DC) [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=3 (with DC) [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=0;
    ...
    vfoptionsjs.lowmemory=3;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=3 (with GI) [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=3 (with GI) [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=0;
    ...
    vfoptionsjs.lowmemory=3;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=3 (with DC+GI) [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=3 (with DC+GI) [EZ %s], this should be zero: %2.8f \n',casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=0;
end
...
%  (vii).3 exact collapse oracles with sj and warm-glow (all three EZ cases).
...
% inside-the-root terminal warm-glow convention (Kraft-Munk-Weiss 2022): the terminal age is
% now the interior recursion with the warm-glow as its continuation, so the composed vNM
% oracle's W-recursion (W=F^x+beta*sj*E[W']+beta*(1-sj)*WG^x, x=1-ezgamma) holds at every age
% including N_j. As in (vi).2 the vNM oracle is the negativeUtils return fn with
% ezsigma=ezgamma discounting with {'beta','sj'}, here plus
% beta*oneminussj*(WG_cons^(1-ezsigma))/(1-ezsigma) in the period return (the cons-units
% warm-glow through the same crosswalk as the return fn; the scale factors enter as trailing
% Params args). Policy exact; V via V_EZ=((1-ezgamma)*V_vNM).^(1/(1-ezgamma)).
ReturnFn_cons_wgvnm=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2) EZReturnFn_negativeUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)+beta*oneminussj*((EZWarmGlowFn_cons(aprime,wg1,wg2)^(1-ezsigma))/(1-ezsigma));
ezphi_store=Params.ezphi;
ezsigma_store=Params.ezsigma;
Params.ezphi=1/Params.ezgamma;
Params.ezsigma=Params.ezgamma;
...
vfoptions1.EZeis='ezphi';
vfoptions1.survivalprobability='sj';
vfoptions1.WarmGlowBequestsFn=@(aprime,wg1,wg2) EZWarmGlowFn_cons(aprime,wg1,wg2);
[V1a,Policy1a]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_cons,Params,DiscountFactorParamNames,[],vfoptions1);
vfoptions2=vfoptions;
vfoptions2.exoticpreferences='None';
...
ReturnFn_posU_wgutil=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negU_wgutil=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
% positive-valued utility fn
vfoptions1=vfoptions;
...
% cons-units became valid under the inside-the-root terminal warm-glow convention
% (Kraft-Munk-Weiss 2022): the cons-units terminal V is (ezc1*F^ezc2)^ezc7=F itself (ezc1=1,
% ezc2*ezc7=1), so its warm-glow fn is the closed-form terminal composite with NO utility wrap.
% Terminal value derivation for this shape: age N_j is retirement (agej>=Jr), so the budget
% is c=(1+r)*a+pension-aprime, independent of the semiz state, the z state and the e shock; V_Nj is attained
% at aprime=0 (consume everything), search effort d2=0 (d2_grid(1)=0 maximizes the
% (1-searcheffortcost*d2) factor) and leisure choice d1=0 (retirement labor earns nothing and
% (1-d1)^(1-varphi) is decreasing in d1), so the terminal composite is x=((1+r)*a+pension)^varphi, giving
%   positive utils: V_Nj(a)=((1+((1+r)*a+pension)^varphi)^(1-ezsigma)-1)/(1-ezsigma)
%   negative utils: V_Nj(a)=((((1+r)*a+pension)^varphi)^(1-ezsigma))/(1-ezsigma)
...
% consumption-units
ReturnFn_cons_scaled2=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZReturnFn_positiveUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZReturnFn_negativeUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
