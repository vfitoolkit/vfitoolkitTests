function output=EZFHorz_nod1_z_e_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_nod1_z_e_semiz.m (which mirrors CoreFHorz_nod1_z_e_semiz.m).
...
ReturnFn_cons=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost) EZReturnFn_cons_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_posU=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost) EZReturnFn_positiveUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_negU=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost) EZReturnFn_negativeUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
...
% consumption-units
ReturnFn_cons_scaled=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZReturnFn_cons_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZReturnFn_positiveUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZReturnFn_negativeUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
ReturnFn_cons_wgvnm=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2) EZReturnFn_negativeUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost)+beta*oneminussj*((EZWarmGlowFn_cons(aprime,wg1,wg2)^(1-ezsigma))/(1-ezsigma));
ezphi_store=Params.ezphi;
ezsigma_store=Params.ezsigma;
Params.ezphi=1/Params.ezgamma;
Params.ezsigma=Params.ezgamma;
...
ReturnFn_posU_wgutil=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negU_wgutil=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
% positive-valued utility fn
vfoptions1=vfoptions;
...
vfoptions1nj.WarmGlowBequestsFn=@(aprime,r,pension) (1+r)*aprime+pension;
...
% consumption-units
ReturnFn_cons_scaled2=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZReturnFn_positiveUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZReturnFn_negativeUtils_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
