function output=EZFHorz_CrossTests_nod_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Epstein-Zin mirror of QHDFHorz_CrossTests_nod_nosemiz.m, run for the three EZ cases.
...
ReturnFn_none_cons=@(aprime,a,r,w,kappa_j,agej,Jr,pension)...
    EZReturnFn_cons_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,agej,Jr,pension);
...
ReturnFn_e_cons=@(aprime,a,e,r,w,kappa_j,agej,Jr,pension)...
    EZReturnFn_cons_nod_noz_e_nosemiz(aprime,a,e,r,w,kappa_j,agej,Jr,pension);
...
ReturnFn_none_posU=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension)...
    EZReturnFn_positiveUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
...
ReturnFn_e_posU=@(aprime,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension)...
    EZReturnFn_positiveUtils_nod_noz_e_nosemiz(aprime,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
...
ReturnFn_none_negU=@(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension)...
    EZReturnFn_negativeUtils_nod_noz_noe_nosemiz(aprime,a,r,w,kappa_j,ezsigma,agej,Jr,pension);
...
ReturnFn_e_negU=@(aprime,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension)...
    EZReturnFn_negativeUtils_nod_noz_e_nosemiz(aprime,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
...
fprintf('Cross test: no shocks vs single-point z, this should be zero: %2.8f \n',max(abs(V0(:)-V0z(:))))
