function output=EZFHorz_CrossTests2_d1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Epstein-Zin mirror of QHDFHorz_CrossTests2_d1_semiz.m, run for the three EZ cases:
...
ReturnFn_semiz_cons=@(d1,d2,aprime,a,semiz,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_cons_d1_noz_noe_semiz(d1,d2,aprime,a,semiz,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_semize_cons=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_cons_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
...
ReturnFn_semiz_posU=@(d1,d2,aprime,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_positiveUtils_d1_noz_noe_semiz(d1,d2,aprime,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_semize_posU=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_positiveUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
...
ReturnFn_semiz_negU=@(d1,d2,aprime,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_negativeUtils_d1_noz_noe_semiz(d1,d2,aprime,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_semize_negU=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_negativeUtils_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
...
simoptions1A=struct();
[V1A,Policy1A]=ValueFnIter_Case1_FHorz(n_d1,n_a,n_z,N_j,d1_grid,a_grid,z_grid,pi_z,ReturnFn_z_cons,Params,DiscountFactorParamNames,[],vfoptions1A);
...
[V2A,Policy2A]=ValueFnIter_Case1_FHorz(n_d1,n_a,n_z,N_j,d1_grid,a_grid,z_grid,pi_z,ReturnFn_ze_cons,Params,DiscountFactorParamNames,[],vfoptions2A);
StationaryDist2A=StationaryDist_FHorz_Case1(jequaloneDist2,AgeWeightParamNames,Policy2A,n_d1,n_a,n_z,N_j,pi_z,Params,simoptions2A);
...
simoptions1A=struct();
[V1A,Policy1A]=ValueFnIter_Case1_FHorz(n_d1,n_a,n_z,N_j,d1_grid,a_grid,z_grid,pi_z,ReturnFn_z_posU,Params,DiscountFactorParamNames,[],vfoptions1A);
StationaryDist1A=StationaryDist_FHorz_Case1(jequaloneDist1,AgeWeightParamNames,Policy1A,n_d1,n_a,n_z,N_j,pi_z,Params,simoptions1A);
...
simoptions2A.e_grid=simoptionsbaseline.e_grid;
simoptions2A.pi_e=simoptionsbaseline.pi_e;
[V2A,Policy2A]=ValueFnIter_Case1_FHorz(n_d1,n_a,n_z,N_j,d1_grid,a_grid,z_grid,pi_z,ReturnFn_ze_posU,Params,DiscountFactorParamNames,[],vfoptions2A);
StationaryDist2A=StationaryDist_FHorz_Case1(jequaloneDist2,AgeWeightParamNames,Policy2A,n_d1,n_a,n_z,N_j,pi_z,Params,simoptions2A);
...
vfoptions1A.EZriskaversion='ezrisk';
simoptions1A=struct();
[V1A,Policy1A]=ValueFnIter_Case1_FHorz(n_d1,n_a,n_z,N_j,d1_grid,a_grid,z_grid,pi_z,ReturnFn_z_negU,Params,DiscountFactorParamNames,[],vfoptions1A);
StationaryDist1A=StationaryDist_FHorz_Case1(jequaloneDist1,AgeWeightParamNames,Policy1A,n_d1,n_a,n_z,N_j,pi_z,Params,simoptions1A);
...
simoptions2A.e_grid=simoptionsbaseline.e_grid;
simoptions2A.pi_e=simoptionsbaseline.pi_e;
[V2A,Policy2A]=ValueFnIter_Case1_FHorz(n_d1,n_a,n_z,N_j,d1_grid,a_grid,z_grid,pi_z,ReturnFn_ze_negU,Params,DiscountFactorParamNames,[],vfoptions2A);
StationaryDist2A=StationaryDist_FHorz_Case1(jequaloneDist2,AgeWeightParamNames,Policy2A,n_d1,n_a,n_z,N_j,pi_z,Params,simoptions2A);
