function output=EZFHorz_CrossTests_d1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Epstein-Zin mirror of QHDFHorz_CrossTests_d1_semiz.m, run for the three EZ cases.
...
ReturnFn_z_cons=@(d1,d2,aprime,a,semiz,z,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_cons_d1_z_noe_semiz(d1,d2,aprime,a,semiz,z,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_e_cons=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_cons_d1_noz_e_semiz(d1,d2,aprime,a,semiz,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_ze_cons=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_cons_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_z_posU=@(d1,d2,aprime,a,semiz,z,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_positiveUtils_d1_z_noe_semiz(d1,d2,aprime,a,semiz,z,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_e_posU=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
...
ReturnFn_ze_posU=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_positiveUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_z_negU=@(d1,d2,aprime,a,semiz,z,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_negativeUtils_d1_z_noe_semiz(d1,d2,aprime,a,semiz,z,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
ReturnFn_e_negU=@(d1,d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
...
ReturnFn_ze_negU=@(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)...
    EZReturnFn_negativeUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost);
...
fprintf('Cross test: single-point z vs single-point e, this should be zero: %2.8f \n',max(abs(V0z(:)-V0e(:))))
