function output=EZFHorz_nod_z_e_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_nod_z_e_nosemiz.m (which mirrors CoreFHorz_nod_z_e_nosemiz.m).
...
ReturnFn_cons=@(aprime,a,z,e,r,w,kappa_j,agej,Jr,pension) EZReturnFn_cons_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,agej,Jr,pension);
ReturnFn_posU=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension) EZReturnFn_positiveUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_negU=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension) EZReturnFn_negativeUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
...
% consumption-units
ReturnFn_cons_scaled=@(aprime,a,z,e,r,w,kappa_j,agej,Jr,pension,ezscalefactor) ezscalefactor*EZReturnFn_cons_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_positiveUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_negativeUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
ReturnFn_posUWGoracle=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negUWGoracle=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
% positive-valued utility fn
vfoptions1=struct();
vfoptions1.n_e=vfoptionsbaseline.n_e;
vfoptions1.e_grid=vfoptionsbaseline.e_grid;
...
% consumption-units
ReturnFn_cons_scaled2=@(aprime,a,z,e,r,w,kappa_j,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.n_e=vfoptionsbaseline.n_e;
vfoptions1.e_grid=vfoptionsbaseline.e_grid;
vfoptions1.pi_e=vfoptionsbaseline.pi_e;
...
% utility-units, positive
ReturnFn_posU_scaled2=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_positiveUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.n_e=vfoptionsbaseline.n_e;
vfoptions1.e_grid=vfoptionsbaseline.e_grid;
vfoptions1.pi_e=vfoptionsbaseline.pi_e;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_negativeUtils_nod_z_e_nosemiz(aprime,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.n_e=vfoptionsbaseline.n_e;
vfoptions1.e_grid=vfoptionsbaseline.e_grid;
vfoptions1.pi_e=vfoptionsbaseline.pi_e;
