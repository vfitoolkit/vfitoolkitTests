function output=EZFHorz_nod_z_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of QHDFHorz_nod_z_noe_nosemiz.m (which mirrors CoreFHorz_nod_z_noe_nosemiz.m).
...
% consumption-units
ReturnFn_cons_scaled=@(aprime,a,z,r,w,kappa_j,agej,Jr,pension,ezscalefactor) ezscalefactor*EZReturnFn_cons_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_positiveUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZReturnFn_negativeUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
Params.ezphi=1/Params.ezgamma;
Params.ezsigma=Params.ezgamma;
ReturnFn_consWGoracle=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2) EZReturnFn_negativeUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*((EZWarmGlowFn_cons(aprime,wg1,wg2)^(1-ezsigma))/(1-ezsigma));
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ezrisk_store=Params.ezrisk;
Params.ezrisk=0;
ReturnFn_posUWGoracle=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_positiveUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_positiveUtils(aprime,wg1,wg2,wg3);
ReturnFn_negUWGoracle=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,beta,oneminussj,wg1,wg2,wg3) EZReturnFn_negativeUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension)+beta*oneminussj*EZWarmGlowFn_negativeUtils(aprime,wg1,wg2,wg3);
% positive-valued utility fn
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
...
% consumption-units
ReturnFn_cons_scaled2=@(aprime,a,z,r,w,kappa_j,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZReturnFn_cons_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_positiveUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZReturnFn_negativeUtils_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=struct();
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
for ezcase=1:3
    ...
    fprintf('Degenerate-z, V identical across z slices [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Vslicedev(:))))
    fprintf('Degenerate-z, Policy identical across z slices [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policyslicedev(:))))
    ...
    fprintf('Degenerate-z vs 1-point z, V [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Vdev(:))))
    fprintf('Degenerate-z vs 1-point z, Policy [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policydev(:))))
end
...
for ezcase=1:3
    ...
    fprintf('z-permutation invariance, V [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Vunperm(:)-Vbase(:))))
    fprintf('z-permutation invariance, Policy [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policyunperm(:)-Policybase(:))))
end
...
for gg=1:2
    ...
    for lam=[1e-3,1e3]
        ...
        fprintf('Homogeneity, lambda=%g (%s) [EZ cons-units], Policy: this should be zero: %.3e \n',lam,gammastr,max(abs(Policylam(:)-Policybase(:))))
...
for ezcase=1:3
    ...
    fprintf('Age-vector EZ params vs scalar, V [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1a(:)-V1b(:))))
    fprintf('Age-vector EZ params vs scalar, Policy [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1a(:)-Policy1b(:))))
end
clear V1a V1b Policy1a Policy1b
