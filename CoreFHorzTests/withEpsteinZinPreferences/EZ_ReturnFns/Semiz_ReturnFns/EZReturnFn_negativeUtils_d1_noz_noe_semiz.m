function F=EZReturnFn_negativeUtils_d1_noz_noe_semiz(d1,d2,aprime,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)
...
if agej<Jr
    c=(1+r)*a+w*kappa_j*d1*semiz+uempbenefit*(1-semiz)-aprime;
else
