function F=EZReturnFn_negativeUtils_nod1_z_noe_semiz(d2,aprime,a,semiz,z,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost)
...
if agej<Jr
    c=(1+r)*a+w*kappa_j*z*semiz+uempbenefit*(1-semiz)-aprime;
else
