function F=EZReturnFn_negativeUtils_nod1_noz_e_semiz(d2,aprime,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost)
...
if agej<Jr
    c=(1+r)*a+w*kappa_j*e*semiz+uempbenefit*(1-semiz)-aprime;
else
