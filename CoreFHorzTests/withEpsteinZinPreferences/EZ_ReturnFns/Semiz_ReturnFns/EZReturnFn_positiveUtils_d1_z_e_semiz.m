function F=EZReturnFn_positiveUtils_d1_z_e_semiz(d1,d2,aprime,a,semiz,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension,varphi,uempbenefit,searcheffortcost)
...
if agej<Jr
    c=(1+r)*a+w*kappa_j*z*e*d1*semiz+uempbenefit*(1-semiz)-aprime;
else
