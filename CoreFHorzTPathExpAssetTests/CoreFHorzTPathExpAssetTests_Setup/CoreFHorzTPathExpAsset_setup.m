...
%
% Combines CoreFHorzExpAsset_setup (d1/d2/d3, a1/a2, ExpAsset aprimeFn) with the TPath
...
vfoptionsbaseline.aprimeFn=@(d2,a2,phi1,phi2) aprimeFn_CoreTestTPathExpAsset(d2,a2,phi1,phi2);
