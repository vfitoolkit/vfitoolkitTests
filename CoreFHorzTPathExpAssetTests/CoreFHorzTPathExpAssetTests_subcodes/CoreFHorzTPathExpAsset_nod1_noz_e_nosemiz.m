function output=CoreFHorzTPathExpAsset_nod1_noz_e_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
FnsToEvaluate.assets=@(d2,a1prime,a1,a2,e) a1+a2;
FnsToEvaluate.earnings=@(d2,a1prime,a1,a2,e,w,kappa_j) w*kappa_j*d2*a2*e;
