function output=CoreFHorzTPathExpAssetz_nod1_z_noe_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d2,a1prime,a1,a2,z,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_TPathExpAssetz_nod1_z_noe_nosemiz(d2,a1prime,a1,a2,z,r,w,kappa_j,sigma,agej,Jr,pension);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d2,a1prime,a1,a2,z) a1+a2;
FnsToEvaluate.earnings=@(d2,a1prime,a1,a2,z,w,kappa_j) w*kappa_j*d2*a2*z;


% Need period T for V and Policy
V_final=zeros([n_a,n_z,N_j],'gpuArray');
Policy_final=ones([2,n_a,n_z,N_j],'gpuArray');
Policy_final_GI=ones([4,n_a,n_z,N_j],'gpuArray');
% big versions of them
V_final_big=zeros([n_a_big,n_z,N_j],'gpuArray');
Policy_final_big=ones([2,n_a_big,n_z,N_j],'gpuArray');
Policy_final_big_GI=ones([4,n_a_big,n_z,N_j],'gpuArray');
