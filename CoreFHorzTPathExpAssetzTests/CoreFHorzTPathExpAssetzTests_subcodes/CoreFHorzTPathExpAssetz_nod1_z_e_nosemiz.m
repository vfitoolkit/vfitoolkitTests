function output=CoreFHorzTPathExpAssetz_nod1_z_e_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,figure_c)

% Setup vfoptions and simoptions
vfoptions=struct();
simoptions=struct();
% ExperienceAssetz (a2, aprime depends on (d2,a2,z))
vfoptions.experienceassetz=vfoptionsbaseline.experienceassetz;
vfoptions.aprimeFn=vfoptionsbaseline.aprimeFn;
simoptions.experienceassetz=simoptionsbaseline.experienceassetz;
simoptions.aprimeFn=simoptionsbaseline.aprimeFn;
simoptions.d_grid=d_grid;
simoptions.a_grid=a_grid;
simoptions.z_grid=z_grid; % aprimeFn depends on z, so sim codes need z_grid
...
ReturnFn=@(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_TPathExpAssetz_nod1_z_e_nosemiz(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d2,a1prime,a1,a2,z,e) a1+a2;
