...
%
% Combines CoreFHorzExpAssetz_setup (d1/d2/d3, a1/a2, ExpAssetz aprimeFn) with the TPath
% additions from CoreFHorzTPath_setup (T, PricePath, ParamPath, transpathoptionsbaseline.fastOLG).
%
...
vfoptionsbaseline.SemiExoStateFn=@(n,nprime,dsemiz,probfindjob,problosejob) CoreFHorzTPathExpAssetzSetup_SemiExoStateFn(n,nprime,dsemiz,probfindjob,problosejob);
...
vfoptionsbaseline.experienceassetz=1;
vfoptionsbaseline.aprimeFn=@(d2,a2,z,phi1,phi2) aprimeFn_CoreTestTPathExpAssetz(d2,a2,z,phi1,phi2);
% a2prime=phi1*(1-d2)*z+(1-phi2)*a2;

simoptionsbaseline.experienceassetz=vfoptionsbaseline.experienceassetz;
simoptionsbaseline.aprimeFn=vfoptionsbaseline.aprimeFn;

Params.phi1=0.3; % ratio at which (1-d2)*z is converted into a2
