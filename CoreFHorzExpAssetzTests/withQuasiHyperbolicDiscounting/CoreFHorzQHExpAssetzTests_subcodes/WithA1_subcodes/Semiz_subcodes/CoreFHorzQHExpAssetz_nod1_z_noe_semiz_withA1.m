function output=CoreFHorzQHExpAssetz_nod1_z_noe_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
% shocks: {semiz (semi-exogenous), z (markov)} -> valid lowmemory {0,1,2}.
%
