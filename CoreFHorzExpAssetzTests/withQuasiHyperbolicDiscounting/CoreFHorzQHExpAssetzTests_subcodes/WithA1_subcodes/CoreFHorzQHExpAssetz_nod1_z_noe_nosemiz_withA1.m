...
% Quasi-hyperbolic experienceassetz, single standard endogenous asset a1 (baseline only).
% shocks: {z (markov)} -> valid lowmemory {0,1}. Runs Naive then Sophisticated, then the
% exponential-discounting cross-tests.
