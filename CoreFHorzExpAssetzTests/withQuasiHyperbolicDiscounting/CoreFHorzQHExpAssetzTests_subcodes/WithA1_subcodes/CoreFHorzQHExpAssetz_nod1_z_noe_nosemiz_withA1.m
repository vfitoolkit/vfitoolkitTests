function output=CoreFHorzQHExpAssetz_nod1_z_noe_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetz, single standard endogenous asset a1: no d1, z.
...
ReturnFn=@(d2,a1prime,a1,a2,z,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetz_nod1_z_noe(d2,a1prime,a1,a2,z,r,w,kappa_j,sigma,agej,Jr,pension);
