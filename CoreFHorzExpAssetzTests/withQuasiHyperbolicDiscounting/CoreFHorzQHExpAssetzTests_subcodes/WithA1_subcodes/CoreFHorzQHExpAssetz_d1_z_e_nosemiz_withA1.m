...
% Quasi-hyperbolic experienceassetz, single standard endogenous asset a1.
% NOTE: QH+experienceassetz supports the BASELINE only for a single a1 (there are no DC1/GI1
% QH-ExpAssetz raws; DC/GI require two standard assets -- see the _with2A1 subcodes).
% So here we test only the base method, at each valid lowmemory level, for Naive then
% Sophisticated, and finish with the exponential-discounting cross-tests.
