function output=CoreFHorzQHExpAssetz_nod1_z_e_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetz, single standard endogenous asset a1: no d1, z, e.
% a = [a1 (standard), a2 (experience asset)]. n_d=n_d2; d_grid=d2_grid
% z is structural here (it enters aprimeFn(d2,a2,z,...)) as well as being the markov shock.
%
...
ReturnFn=@(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetz_nod1_z_e(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension);
