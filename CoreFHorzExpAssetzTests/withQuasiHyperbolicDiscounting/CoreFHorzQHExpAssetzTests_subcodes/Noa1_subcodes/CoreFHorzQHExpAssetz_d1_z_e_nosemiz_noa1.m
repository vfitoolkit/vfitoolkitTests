function output=CoreFHorzQHExpAssetz_d1_z_e_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassetz, noa1: the experience asset a2 is the only endogenous state.
...
%
% TEST-FIRST: written ahead of the toolkit code. QH+experienceassetz has no noa1 support
...
ReturnFn=@(d1,d2,a,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssetz_d1_z_e_noa1(d1,d2,a,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
