function output=CoreFHorzExpAssetz_d1_z_e_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
% high-return asset (return r2>r, holdings in {0,1}). The experienceassetz a2 is
% unchanged. a = [a1_1 (liquid, divide-conquered), a1_2 (multi-point, folded), a2 (exp asset)]
% Exercises the ExpAssetzSemiExo DC2A/GI2A/DC2A_GI2A raws.
...
ReturnFn=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetz_d1_z_e_semiz_with2A1(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);
