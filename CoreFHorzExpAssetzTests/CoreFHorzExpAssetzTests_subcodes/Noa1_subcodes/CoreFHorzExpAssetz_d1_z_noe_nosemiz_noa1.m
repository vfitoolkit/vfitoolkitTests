function output=CoreFHorzExpAssetz_d1_z_noe_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssetz noa1: with d1 (labour), z, no e. Experience asset is the only endogenous state.
...
FnsToEvaluate.earnings=@(d1,d2,a,z,w,kappa_j) w*kappa_j*d1*d2*a*z;
...
title('Age-conditional experience asset (d1+z, noa1)')
