function output=CoreFHorzExpAssetz_nod1_z_e_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssetz noa1: no d1, z, e. Experience asset is the only endogenous state.
...
FnsToEvaluate.assets=@(d2,a,z,e) a;
FnsToEvaluate.earnings=@(d2,a,z,e,w,kappa_j) w*kappa_j*d2*a*z*e;
...
title('Age-conditional experience asset (z+e, noa1)')
