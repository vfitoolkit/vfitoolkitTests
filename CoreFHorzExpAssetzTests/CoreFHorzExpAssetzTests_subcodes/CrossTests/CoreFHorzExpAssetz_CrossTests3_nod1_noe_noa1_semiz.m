function output=CoreFHorzExpAssetz_CrossTests3_nod1_noe_noa1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 3 (nod1, semiz, noe): noa1 ExpAssetz+SemiExo vs a1=1 degenerate ExpAssetz+SemiExo.
...
% This is the shock-leanest variant (z only); the z+e variant is CoreFHorzExpAssetz_CrossTests3_nod1_noa1_semiz.
%
...
%% (z)
ReturnFn_A=@(d2,d3,a,semiz,z,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetz_nod1_z_noe_semiz_noa1(d2,d3,a,semiz,z,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_B=@(d2,d3,a1prime,a1,a2,semiz,z,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssetz_nod1_z_noe_semiz_noa1(d2,d3,a2,semiz,z,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
...
fprintf('Cross test 3 (noa1 vs a1=1, nod1 semiz z noe): sim panel means should roughly match: %2.8f vs %2.8f \n',mean(SimPanel_A.assets,'all'),mean(SimPanel_B.assets,'all'))
