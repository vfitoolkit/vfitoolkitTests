function output=CoreFHorzExpAssetz_CrossTests3_d1_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 3 (d1, nosemiz): noa1 ExpAssetz vs a1=1 degenerate ExpAssetz.
...
%% (z, e)
ReturnFn_A=@(d1,d2,a,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssetz_d1_z_e_noa1(d1,d2,a,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
ReturnFn_B=@(d1,d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssetz_d1_z_e_noa1(d1,d2,a2,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);

jequaloneDist_A=zeros([n_a,n_z,n_e],'gpuArray');
jequaloneDist_A(1,ceil(n_z/2),ceil(n_e/2))=1;
jequaloneDist_B=zeros([n_a_B,n_z,n_e],'gpuArray');
jequaloneDist_B(1,1,ceil(n_z/2),ceil(n_e/2))=1;
...
fprintf('Cross test 3 (noa1 vs a1=1, d1 z e): sim panel means should roughly match: %2.8f vs %2.8f \n',mean(SimPanel_A.assets,'all'),mean(SimPanel_B.assets,'all'))
