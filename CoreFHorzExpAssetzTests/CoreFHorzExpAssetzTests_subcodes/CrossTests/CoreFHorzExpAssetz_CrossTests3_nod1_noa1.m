function output=CoreFHorzExpAssetz_CrossTests3_nod1_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 3 (nod1, nosemiz): noa1 ExpAssetz vs a1=1 degenerate ExpAssetz.
...
%% (z, e)
ReturnFn_A=@(d2,a,z,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetz_nod1_z_e_noa1(d2,a,z,e,r,w,kappa_j,sigma,agej,Jr,pension);
ReturnFn_B=@(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetz_nod1_z_e_noa1(d2,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension);
...
fprintf('Cross test 3 (noa1 vs a1=1, nod1 z e): sim panel means should roughly match: %2.8f vs %2.8f \n',mean(SimPanel_A.assets,'all'),mean(SimPanel_B.assets,'all'))
