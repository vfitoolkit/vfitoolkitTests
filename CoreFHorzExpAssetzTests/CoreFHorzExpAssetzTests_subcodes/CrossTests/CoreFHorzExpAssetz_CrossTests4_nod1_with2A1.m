function output=CoreFHorzExpAssetz_CrossTests4_nod1_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 4 (with2A1, nod1): a DEGENERATE second standard asset a1_2 (single grid point {0})
...
ReturnFn_A=@(d2,a1prime,a1,a2,z,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetz_nod1_z_noe(d2,a1prime,a1,a2,z,r,w,kappa_j,sigma,agej,Jr,pension);
...
ReturnFn_B=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,r,r2,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssetz_nod1_z_noe_with2A1(d2,a1prime,a1_2prime,a1,a1_2,a2,z,r,r2,w,kappa_j,sigma,agej,Jr,pension);
...
fprintf('Cross test 4 (with2A1, nod1): degenerate a1_2 reduces to with-a1, this should be zero: V %2.8f, Dist %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))))
