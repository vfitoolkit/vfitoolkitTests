function F=ReturnFn_ExpAssetz_d1_z_noe_with2A1(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,z,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension)
...
if agej<Jr
    c=(1+r)*a1+(1+r2)*a1_2+w*kappa_j*d1*d2*a2*z-a1prime-a1_2prime;
else
