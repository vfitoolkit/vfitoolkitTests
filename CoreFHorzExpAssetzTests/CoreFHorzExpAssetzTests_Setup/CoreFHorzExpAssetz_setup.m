...
% experienceassetz: aprime depends on (d2,a2,z)
...
vfoptionsbaseline.SemiExoStateFn=@(n,nprime,dsemiz,probfindjob,problosejob) CoreFHorzExpAssetzSetup_SemiExoStateFn(n,nprime,dsemiz,probfindjob,problosejob);
...
vfoptionsbaseline.aprimeFn=@(d2,a2,z,phi1,phi2) aprimeFn_CoreTestExpAssetz(d2,a2,z,phi1,phi2);
