function output=CoreFHorzExpAssete_d1_noz_e_with2A1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_ExpAssete_d1_noz_e_with2A1_semiz(d1,d2,d3,a1prime,a1_2prime,a1,a1_2,a2,semiz,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension,uempbenefit,searcheffortcost);
...
title('Earnings Mean (with2A1, d1+semiz+e)')
legend('1','3')
