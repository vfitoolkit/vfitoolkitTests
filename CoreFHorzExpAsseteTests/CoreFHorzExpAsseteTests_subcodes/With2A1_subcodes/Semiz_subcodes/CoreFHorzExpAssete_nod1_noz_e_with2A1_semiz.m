function output=CoreFHorzExpAssete_nod1_noz_e_with2A1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
title('Earnings Mean (with2A1, semiz+e)')
legend('1','3')
