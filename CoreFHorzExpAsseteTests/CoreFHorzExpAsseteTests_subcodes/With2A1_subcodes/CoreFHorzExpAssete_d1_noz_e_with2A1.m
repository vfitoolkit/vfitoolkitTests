function output=CoreFHorzExpAssete_d1_noz_e_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
jequaloneDist(1,1,1,ceil(vfoptions.n_e/2))=1;

ReturnFn=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssete_d1_noz_e_with2A1(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);

% Setup some FnsToEvaluate
FnsToEvaluate.assets=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e) a1;
FnsToEvaluate.assets2=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e) a1_2;
FnsToEvaluate.humancapital=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e) a2;
FnsToEvaluate.earnings=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e,w,kappa_j) w*kappa_j*d1*d2*a2*e;
...
jequaloneDist5(1,1,1,ceil(vfoptions.n_e/2))=1;
