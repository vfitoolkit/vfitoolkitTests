function output=CoreFHorzExpAssete_CrossTests4_nod1_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
...
% Follows CoreFHorzExpAsset_CrossTests_nod1_nosemiz_with2A1, adapted to experienceassete
...
ReturnFn_A=@(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssete_nod1_z_e(d2,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,agej,Jr,pension);
...
ReturnFn_B=@(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e,r,r2,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssete_nod1_z_e_with2A1(d2,a1prime,a1_2prime,a1,a1_2,a2,z,e,r,r2,w,kappa_j,sigma,agej,Jr,pension);
...
fprintf('Cross test 4 (with2A1, nod1, z e): degenerate a1_2 reduces to withA1, this should be zero: V %2.8f, Dist %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))))
