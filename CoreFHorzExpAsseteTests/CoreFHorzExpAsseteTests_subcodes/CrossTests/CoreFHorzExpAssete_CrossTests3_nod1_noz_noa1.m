function output=CoreFHorzExpAssete_CrossTests3_nod1_noz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test 3 (nod1): noa1 ExpAssete vs a1=1 degenerate ExpAssete.
...
% Follows CoreFHorzExpAsset_CrossTests4_nod1_nosemiz, adapted to experienceassete
...
%% noz, e
ReturnFn_A=@(d2,a,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssete_nod1_noz_e_noa1(d2,a,e,r,w,kappa_j,sigma,agej,Jr,pension);
ReturnFn_B=@(d2,a1prime,a1,a2,e,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_ExpAssete_nod1_noz_e_noa1(d2,a2,e,r,w,kappa_j,sigma,agej,Jr,pension);
...
fprintf('Cross test 3 (noa1 vs a1=1, nod1 noz e): sim panel means should roughly match: %2.8f vs %2.8f \n',mean(SimPanel_A.assets,'all'),mean(SimPanel_B.assets,'all'))
