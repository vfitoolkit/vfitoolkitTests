function output=CoreFHorzExpAssete_nod1_z_e_noa1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssete noa1 + semiz: no d1, z, e. Experience asset (a2) is the only endogenous state.
...
% test-first), so this errors at the ValueFnIter call.
