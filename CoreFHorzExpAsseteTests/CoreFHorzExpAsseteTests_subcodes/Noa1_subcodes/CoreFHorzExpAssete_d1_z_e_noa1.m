function output=CoreFHorzExpAssete_d1_z_e_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssete noa1: with d1 (labour), z, e. Experience asset (a2) is the only endogenous state.
