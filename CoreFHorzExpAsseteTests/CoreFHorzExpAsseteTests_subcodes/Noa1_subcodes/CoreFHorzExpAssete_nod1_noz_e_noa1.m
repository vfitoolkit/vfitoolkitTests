function output=CoreFHorzExpAssete_nod1_noz_e_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAssete noa1: no d1, no z, e. Experience asset (a2) is the only endogenous state.
