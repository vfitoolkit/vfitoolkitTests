...
% experienceassete: aprime depends on (d2,a2,e)
...
vfoptionsbaseline.SemiExoStateFn=@(n,nprime,dsemiz,probfindjob,problosejob) CoreFHorzExpAsseteSetup_SemiExoStateFn(n,nprime,dsemiz,probfindjob,problosejob);
...
vfoptionsbaseline.experienceassete=1;
vfoptionsbaseline.aprimeFn=@(d2,a2,e,phi1,phi2) aprimeFn_CoreTestExpAssete(d2,a2,e,phi1,phi2);
% a2prime=phi1*(1-d2)*e+(1-phi2)*a2;


simoptionsbaseline.experienceassete=vfoptionsbaseline.experienceassete;
simoptionsbaseline.aprimeFn=vfoptionsbaseline.aprimeFn;

Params.phi1=0.3; % ratio at which (1-d2)*e is converted into a2
