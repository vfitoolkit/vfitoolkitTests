function output=CoreFHorzQHExpAssete_d1_z_e_with2A1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
% conquered, the binary a1_2 is folded, a2 is the experience asset. with d1 (labour), z, e.
