function output=CoreFHorzQHExpAssete_d1_noz_e_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceassete with TWO standard endogenous assets -> triggers
% the DC2A / GI2A / DC2A_GI2A code paths (used whenever length(n_a1)>1): a1_1 is divide-
% conquered, the binary a1_2 is folded, a2 is the experience asset. with d1 (labour), no z, e.
