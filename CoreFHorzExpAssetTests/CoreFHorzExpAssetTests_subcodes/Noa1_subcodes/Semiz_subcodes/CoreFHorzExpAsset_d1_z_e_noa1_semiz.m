function output=CoreFHorzExpAsset_d1_z_e_noa1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAsset noa1 + semiz: with d1 (labour), z, e. Experience asset is the only endogenous state.
...
FnsToEvaluate.earnings=@(d1,d2,d3,a,semiz,z,e,w,kappa_j) w*kappa_j*d1*d2*a*z*e*semiz;
...
title('Age-conditional assets (d1+semiz+z+e, noa1)')
