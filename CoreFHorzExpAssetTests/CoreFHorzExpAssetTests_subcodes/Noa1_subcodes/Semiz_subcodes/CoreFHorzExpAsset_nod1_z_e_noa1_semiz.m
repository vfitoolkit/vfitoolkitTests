function output=CoreFHorzExpAsset_nod1_z_e_noa1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% ExpAsset noa1 + semiz: no d1, z, e. Experience asset is the only endogenous state.
...
FnsToEvaluate.assets=@(d2,d3,a,semiz,z,e) a;
FnsToEvaluate.earnings=@(d2,d3,a,semiz,z,e,w,kappa_j) w*kappa_j*d2*a*z*e*semiz;
...
fprintf('noa1 moments (semiz+z+e)\n')
...
title('Age-conditional assets (semiz+z+e, noa1)')
