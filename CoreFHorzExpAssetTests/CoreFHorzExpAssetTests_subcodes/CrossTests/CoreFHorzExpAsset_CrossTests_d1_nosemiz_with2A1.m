function output=CoreFHorzExpAsset_CrossTests_d1_nosemiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
...
vfoptionsA=struct(); vfoptionsA.experienceasset=1; vfoptionsA.aprimeFn=aprimeFn;
simoptionsA=struct(); simoptionsA.experienceasset=1; simoptionsA.aprimeFn=aprimeFn; simoptionsA.d_grid=d_grid; simoptionsA.a_grid=a_grid;
...
ReturnFn_B=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_d1_noz_noe_nosemiz_with2A1(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
vfoptionsB=struct(); vfoptionsB.experienceasset=1; vfoptionsB.aprimeFn=aprimeFn;
simoptionsB=struct(); simoptionsB.experienceasset=1; simoptionsB.aprimeFn=aprimeFn; simoptionsB.d_grid=d_grid; simoptionsB.a_grid=a_grid_B;
...
fprintf('Cross test (with2A1, d1): degenerate a1_2 reduces to with-a1, this should be zero: V %2.8f, Dist %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))))
