function output=CoreFHorzExpAsset_CrossTests_nod1_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Markov-as-iid equivalence cross-test, noa1 nosemiz nod1 version.
% Mirrors CoreFHorzExpAsset_CrossTests_nod1_nosemiz.m but with the experience asset as the only endogenous state.
