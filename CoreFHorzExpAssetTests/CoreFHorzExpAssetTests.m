...
% with/without semiz
%
% This is all done with a1, then rerun all 16 without a1 (divide-and-conquer and grid interpolation layer no longer relevant)
...
%% Now repeat all 16 without a1 (experience asset is the only endogenous state)
