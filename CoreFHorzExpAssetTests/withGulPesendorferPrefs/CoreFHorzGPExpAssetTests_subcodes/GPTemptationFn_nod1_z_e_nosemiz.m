function T=GPTemptationFn_nod1_z_e_nosemiz(d2,a1prime,a1,a2,z,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension)
...
if agej<Jr
    c=(1+r)*a1+w*kappa_j*d2*a2*z*e-a1prime;
else
