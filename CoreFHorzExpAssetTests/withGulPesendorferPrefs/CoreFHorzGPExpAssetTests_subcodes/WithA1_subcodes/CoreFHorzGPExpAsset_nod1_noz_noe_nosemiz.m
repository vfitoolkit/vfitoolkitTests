function output=CoreFHorzGPExpAsset_nod1_noz_noe_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Gul-Pesendorfer experienceasset, single standard endogenous asset a1: no d1, no z, no e.
...
vfoptions.temptationFn=@(d2,a1prime,a1,a2,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension) GPTemptationFn_nod1_noz_noe_nosemiz(d2,a1prime,a1,a2,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension);
