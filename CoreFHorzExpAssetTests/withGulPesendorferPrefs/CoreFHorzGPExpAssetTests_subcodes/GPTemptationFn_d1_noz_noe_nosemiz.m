function T=GPTemptationFn_d1_noz_noe_nosemiz(d1,d2,a1prime,a1,a2,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension)
...
if agej<Jr
    c=(1+r)*a1+w*kappa_j*d1*d2*a2-a1prime;
else
