function output=CoreFHorzGPExpAsset_d1_noz_noe_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Gul-Pesendorfer experienceasset, noa1: with d1 (labour), no z, no e.
...
% DC/GI/DC+GI blocks). Runs the GP solve at lowmemory=0 only (there
...
vfoptions.temptationFn=@(d1,d2,a,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension) GPTemptationFn_d1_noz_noe_noa1_nosemiz(d1,d2,a,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension);
