function output=CoreFHorzGPExpAsset_nod1_noz_e_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Gul-Pesendorfer experienceasset, noa1: no d1, no z, e.
...
vfoptions.temptationFn=@(d2,a,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension) GPTemptationFn_nod1_noz_e_noa1_nosemiz(d2,a,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension);
