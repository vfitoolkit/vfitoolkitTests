function output=CoreFHorzQHExpAsset_d1_z_e_noa1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Quasi-hyperbolic experienceasset, noa1: with d1 (labour), z, e.
...
ReturnFn=@(d1,d2,a,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_d1_z_e_noa1_nosemiz(d1,d2,a,z,e,r,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
