...
%   - with-a1 case: DC IS supported by the toolkit; GI / DC+GI are pending toolkit support
%     (subcodes wire them up so they'll work once GI is added).
%
%
% Note: This uses the opposite ordering (first without a1, then with a1),
...
%% DC is supported by the toolkit for with-a1 RiskyAsset; GI / DC+GI are
%% wired up but currently pending toolkit support.
...
% should run cleanly except GI / DC+GI blocks (pending toolkit support)
