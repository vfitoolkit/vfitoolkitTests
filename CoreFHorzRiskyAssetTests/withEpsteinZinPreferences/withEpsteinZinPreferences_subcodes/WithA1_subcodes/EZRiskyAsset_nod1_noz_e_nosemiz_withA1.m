function output=EZRiskyAsset_nod1_noz_e_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c) %#ok<INUSD>
% Epstein-Zin mirror of CoreFHorzRiskyAsset_nod1_noz_e_nosemiz_withA1.m. The model is run three times:
...
ReturnFn_cons=@(savings,a1prime,a1,a2,e,r,w,kappa_j,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,r_a1,agej,Jr,pension);
ReturnFn_posU=@(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension);
ReturnFn_negU=@(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(riskyshare,savings,a1prime,a1,a2,e) a1;
FnsToEvaluate.a2=@(riskyshare,savings,a1prime,a1,a2,e) a2;
FnsToEvaluate.savings=@(riskyshare,savings,a1prime,a1,a2,e) savings;
FnsToEvaluate.earnings=@(riskyshare,savings,a1prime,a1,a2,e,w,kappa_j) w*kappa_j*e;
...
% EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz_withA1 with ezsigma=ezgamma. So: identical Policy
...
% consumption-units
ReturnFn_cons_scaled=@(savings,a1prime,a1,a2,e,r,w,kappa_j,r_a1,agej,Jr,pension,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
% consumption-units
ReturnFn_cons_scaled2=@(savings,a1prime,a1,a2,e,r,w,kappa_j,r_a1,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
