function output=EZRiskyAsset_d1_noz_noe_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c) %#ok<INUSD>
% Epstein-Zin mirror of CoreFHorzRiskyAsset_d1_noz_noe_nosemiz_withA1.m. The model is run three times:
...
% u-shock is part of the EZ certainty-equivalent: ONE joint CE over (u) — the
...
% Note: despite noz_noe this is NOT a no-shock model (the u-shock always provides genuine
...
ReturnFn_cons=@(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_posU=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_negU=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(h,riskyshare,savings,a1prime,a1,a2) a1;
FnsToEvaluate.a2=@(h,riskyshare,savings,a1prime,a1,a2) a2;
FnsToEvaluate.savings=@(h,riskyshare,savings,a1prime,a1,a2) savings;
FnsToEvaluate.earnings=@(h,riskyshare,savings,a1prime,a1,a2,w,kappa_j) w*kappa_j*h;
...
% the u-expectation sits INSIDE the joint certainty-equivalent (one CE over (u)), so a
...
% EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz_withA1 with ezsigma=ezgamma. So: identical Policy
...
% continuation EV — here one joint CE over (u) — and linear interpolation commutes with
...
% consumption-units
ReturnFn_cons_scaled=@(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
for ezcase=1:3
    vfoptionsv=vfoptions; % baseline vfoptions: the riskyasset settings
...
% (basic and GI), basic==DC, GI==DC+GI.
for ezcase=1:3
    vfoptionsv=vfoptions; % baseline vfoptions: the riskyasset settings
    vfoptionsv.exoticpreferences='EpsteinZin';
    if ezcase==1 % consumption-units (traditional Epstein-Zin)
...
% consumption-units
ReturnFn_cons_scaled2=@(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
