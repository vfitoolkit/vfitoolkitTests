function output=EZRiskyAsset_d1_z_e_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of CoreFHorzRiskyAsset_d1_z_e_nosemiz_withA1.m. The model is run three times:
...
ReturnFn_cons=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_posU=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_negU=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(h,riskyshare,savings,a1prime,a1,a2,z,e) a1;
FnsToEvaluate.a2=@(h,riskyshare,savings,a1prime,a1,a2,z,e) a2;
FnsToEvaluate.savings=@(h,riskyshare,savings,a1prime,a1,a2,z,e) savings;
FnsToEvaluate.earnings=@(h,riskyshare,savings,a1prime,a1,a2,z,e,w,kappa_j) w*kappa_j*h*z*e;
...
% EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz_withA1 with ezsigma=ezgamma. So: identical Policy
...
% consumption-units
ReturnFn_cons_scaled=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
for ezcase=1:3
    ...
    vfoptions2.lowmemory=2;
    [V2C,Policy2C]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions2);
    fprintf('warm-glow with sj, lowmemory=2 (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V2(:)-V2C(:))))
    ...
    vfoptions3.lowmemory=2;
    [V3C,Policy3C]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions3);
    fprintf('warm-glow with sj, lowmemory=2 (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3(:)-V3C(:))))
    ...
    vfoptions4.lowmemory=2;
    [V4C,Policy4C]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions4);
    fprintf('warm-glow with sj, lowmemory=2 (with DC+GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V4(:)-V4C(:))))
...
% consumption-units
ReturnFn_cons_scaled2=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
