function output=EZRiskyAsset_d1_noz_e_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c) %#ok<INUSD>
% Epstein-Zin mirror of CoreFHorzRiskyAsset_d1_noz_e_nosemiz_withA1.m. The model is run three times:
...
% u-shock is part of the EZ certainty-equivalent: ONE joint CE over (u, eprime) — the
...
% until implemented; and no EZ riskyasset raw handles n_z=0 yet, so even the basic solves
% of this noz shape are EXPECTED to error until implemented.
% Note: despite noz this is NOT a no-shock model (the u-shock always provides genuine
% risk), so no 'EZ without shocks' warning is expected anywhere in this subcode.
...
jequaloneDist=zeros([n_a_big,vfoptions.n_e],'gpuArray');
jequaloneDist(1,1,ceil(vfoptions.n_e/2))=1;

ReturnFn_cons=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_posU=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_negU=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(h,riskyshare,savings,a1prime,a1,a2,e) a1;
FnsToEvaluate.a2=@(h,riskyshare,savings,a1prime,a1,a2,e) a2;
FnsToEvaluate.savings=@(h,riskyshare,savings,a1prime,a1,a2,e) savings;
FnsToEvaluate.earnings=@(h,riskyshare,savings,a1prime,a1,a2,e,w,kappa_j) w*kappa_j*h*e;
...
% the u-expectation sits INSIDE the joint certainty-equivalent (one CE over (u, eprime)), so a
...
% EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz_withA1 with ezsigma=ezgamma. So: identical Policy
...
% continuation EV — here one joint CE over (u, eprime) — and linear interpolation commutes with
...
% consumption-units
ReturnFn_cons_scaled=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
fprintf('EZ with EZriskaversion=0 and sj (GI) [EZ positive utils]: should give zero: %.3e \n',max(abs(V2c(:)-V2d(:))))
...
fprintf('EZ with EZriskaversion=0 and sj (GI) [EZ negative utils]: should give zero: %.3e \n',max(abs(V3c(:)-V3d(:))))
...
for ezcase=1:3
    ...
    fprintf('sj, ValueFnFromPolicy (GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3fromPolicy(:)-V3(:))))
...
for ezcase=1:3
    ...
    fprintf('warm-glow terminal-only, ValueFnFromPolicy (GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3fromPolicy(:)-V3(:))))
...
for ezcase=1:3
    ...
    fprintf('warm-glow with sj, ValueFnFromPolicy (GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3fromPolicy(:)-V3(:))))
    ...
    vfoptions1.lowmemory=1;
    [V1B,Policy1B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions1);
    fprintf('warm-glow with sj, lowmemory=1 [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V1B(:))))
    fprintf('warm-glow with sj, lowmemory=1 [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy1B(:))))
    vfoptions1.lowmemory=0;
    vfoptions2.lowmemory=1;
    [V2B,Policy2B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions2);
    fprintf('warm-glow with sj, lowmemory=1 (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V2(:)-V2B(:))))
    fprintf('warm-glow with sj, lowmemory=1 (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy2(:)-Policy2B(:))))
    vfoptions2.lowmemory=0;
    vfoptions3.lowmemory=1;
    [V3B,Policy3B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions3);
    fprintf('warm-glow with sj, lowmemory=1 (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3(:)-V3B(:))))
    fprintf('warm-glow with sj, lowmemory=1 (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy3(:)-Policy3B(:))))
    vfoptions3.lowmemory=0;
    vfoptions4.lowmemory=1;
    [V4B,Policy4B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions4);
    fprintf('warm-glow with sj, lowmemory=1 (with DC+GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V4(:)-V4B(:))))
    fprintf('warm-glow with sj, lowmemory=1 (with DC+GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy4(:)-Policy4B(:))))
    vfoptions4.lowmemory=0;
end
clear V1 V2 V3 V4 Policy1 Policy2 Policy3 Policy4 V1fromPolicy V3fromPolicy V1B V2B V3B V4B Policy1B Policy2B Policy3B Policy4B
...
for ezcase=1:3
    ...
    fprintf('EZmortalityriskaversion distinct, ValueFnFromPolicy (GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3fromPolicy(:)-V3(:))))
...
% consumption-units
ReturnFn_cons_scaled2=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
