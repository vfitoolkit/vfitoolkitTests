function output=EZRiskyAsset_nod1_z_e_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of CoreFHorzRiskyAsset_nod1_z_e_semiz_withA1.m (riskyasset with a1+a2:
...
% (u, semizprime, zprime, eprime) — the collapse tests only hold exactly if the implementation
...
% n_d=[n_d2,n_d3,n_d4] = [riskyshare, savings, semiz decision];   n_a=[n_a1,n_a2]
...
vfoptions.refine_d=[0,1,1,1]; % no d1, 1 d2 (riskyshare), 1 d3 (savings), 1 d4 (semiz decision)
...
ReturnFn_cons=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_posU=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_negU=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,z,e) a1;
FnsToEvaluate.a2=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,z,e) a2;
FnsToEvaluate.savings=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,z,e) savings;
FnsToEvaluate.earnings=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,z,e,w,kappa_j) w*kappa_j*z*e*semiz;
...
%%
clear V1 V2 V1B V2B V1C V2C V1D V2D Policy1 Policy2 Policy1B Policy2B Policy1C Policy2C Policy1D Policy2D V1fromPolicy
...
%%
clear V3 V4 V3B V4B V3C V4C V3D V4D Policy3 Policy4 Policy3B Policy4B Policy3C Policy4C Policy3D Policy4D V3fromPolicy
...
% consumption-units
ReturnFn_cons_scaled=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
[V1b,Policy1b]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_negU,Params,{'beta','sj'},[],vfoptions2);
V1btransformed=((1-Params.ezgamma)*V1b).^(1/(1-Params.ezgamma));
fprintf('EZ gamma=1/phi collapse with sj (GI), Policy: should give zero: %.3e \n',max(abs(Policy1a(:)-Policy1b(:))))
...
[V2a,Policy2a]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_posU,Params,DiscountFactorParamNames,[],vfoptions1);
[V2b,Policy2b]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_posU,Params,{'beta','sj'},[],vfoptions2);
fprintf('EZ (positive utils) with EZriskaversion=0 and sj (GI): should give zero: %.3e \n',max(abs(V2a(:)-V2b(:))))
fprintf('EZ (positive utils) with EZriskaversion=0 and sj (GI): should give zero: %.3e \n',max(abs(Policy2a(:)-Policy2b(:))))
% negative-valued utility fn
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
...
[V3a,Policy3a]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_negU,Params,DiscountFactorParamNames,[],vfoptions1);
[V3b,Policy3b]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn_negU,Params,{'beta','sj'},[],vfoptions2);
fprintf('EZ (negative utils) with EZriskaversion=0 and sj (GI): should give zero: %.3e \n',max(abs(V3a(:)-V3b(:))))
fprintf('EZ (negative utils) with EZriskaversion=0 and sj (GI): should give zero: %.3e \n',max(abs(Policy3a(:)-Policy3b(:))))
Params.ezrisk=ezrisk_store;
clear V2a V2b V3a V3b Policy2a Policy2b Policy3a Policy3b
...
for ezcase=1:3
    ...
    fprintf('ValueFnFromPolicy with sj (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3fromPolicy(:)-V3(:))))
end
...
for ezcase=1:3
    ...
    vfoptions2.lowmemory=1;
    [V2B,Policy2B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions2);
    fprintf('lowmemory=1 with warm-glow and sj (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V2(:)-V2B(:))))
    fprintf('lowmemory=1 with warm-glow and sj (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy2(:)-Policy2B(:))))
    vfoptions2.lowmemory=2;
    [V2C,Policy2C]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions2);
    fprintf('lowmemory=2 with warm-glow and sj (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V2(:)-V2C(:))))
    fprintf('lowmemory=2 with warm-glow and sj (with DC) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy2(:)-Policy2C(:))))
    vfoptions2.lowmemory=0;
    vfoptions3.lowmemory=1;
    [V3B,Policy3B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions3);
    fprintf('lowmemory=1 with warm-glow and sj (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3(:)-V3B(:))))
    fprintf('lowmemory=1 with warm-glow and sj (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy3(:)-Policy3B(:))))
    vfoptions3.lowmemory=2;
    [V3C,Policy3C]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions3);
    fprintf('lowmemory=2 with warm-glow and sj (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V3(:)-V3C(:))))
    fprintf('lowmemory=2 with warm-glow and sj (with GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy3(:)-Policy3C(:))))
    vfoptions3.lowmemory=0;
    vfoptions4.lowmemory=1;
    [V4B,Policy4B]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions4);
    fprintf('lowmemory=1 with warm-glow and sj (with DC+GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V4(:)-V4B(:))))
    fprintf('lowmemory=1 with warm-glow and sj (with DC+GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy4(:)-Policy4B(:))))
    vfoptions4.lowmemory=2;
    [V4C,Policy4C]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptions4);
    fprintf('lowmemory=2 with warm-glow and sj (with DC+GI) [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V4(:)-V4C(:))))
...
% consumption-units
ReturnFn_cons_scaled2=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
