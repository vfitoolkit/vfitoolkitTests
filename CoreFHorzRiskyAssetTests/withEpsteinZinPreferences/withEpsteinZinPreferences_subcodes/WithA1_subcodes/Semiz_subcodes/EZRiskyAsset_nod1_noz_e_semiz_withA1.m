function output=EZRiskyAsset_nod1_noz_e_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c) %#ok<INUSD>
% Epstein-Zin mirror of CoreFHorzRiskyAsset_nod1_noz_e_semiz_withA1.m (riskyasset with a1+a2:
...
% (u, semizprime, eprime) — the collapse tests only hold exactly if the implementation
...
ReturnFn_cons=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_posU=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_negU=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e) a1;
FnsToEvaluate.a2=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e) a2;
FnsToEvaluate.savings=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e) savings;
FnsToEvaluate.earnings=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e,w,kappa_j) w*kappa_j*e*semiz;
...
% consumption-units
ReturnFn_cons_scaled=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
% consumption-units
ReturnFn_cons_scaled2=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
