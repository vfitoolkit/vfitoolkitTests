function output=EZRiskyAsset_CrossTests_semizasz_d1_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (semiz-as-z): RiskyAsset, d1, WITH a1 -- EPSTEIN-ZIN version.
...
% Mirrors CoreFHorzRiskyAsset_CrossTests_semizasz_d1_withA1 mechanics, for the three EZ cases.
% TEST-FIRST: the semiz-side solves need EZ riskyasset d1 semiz withA1 raws (do not exist yet)
% with n_z=0.
%
...
ReturnFn_z_noe_cons=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,z,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_s_noe_cons=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_cons=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_s_e_cons=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_e_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_noe_posU=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_s_noe_posU=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_posU=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_s_e_posU=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_e_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_noe_negU=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_s_noe_negU=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_negU=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_s_e_negU=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_e_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
...
for ezcase=1:3
    ...
    fprintf('CrossTest semizasz (d1 noe, withA1) [EZ %s]: should be zero: V %2.8f, Policy(h,riskyshare,savings) %2.8f, Dist %2.8f \n',casestr,max(abs(V_z(:)-V_s(:))),max(abs(Pd_z(:)-Pd_s(:))),max(abs(StationaryDist_z(:)-StationaryDist_s(:))))
    ...
    Pd_z=Policy_z(1:3,:); Pd_s=Policy_s(1:3,:);
    fprintf('CrossTest semizasz (d1 e, withA1) [EZ %s]: should be zero: V %2.8f, Policy(h,riskyshare,savings) %2.8f, Dist %2.8f \n',casestr,max(abs(V_z(:)-V_s(:))),max(abs(Pd_z(:)-Pd_s(:))),max(abs(StationaryDist_z(:)-StationaryDist_s(:))))
