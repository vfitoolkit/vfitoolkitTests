...
for ezcase=1:3
    ...
    PdA=Policy_A(1:l_d,:); PdB=Policy_B(1:l_d,:);
    fprintf('CrossTest plainvswithA1 (nod1 z noe) [EZ %s]: should be zero: V %.3e, Policy %.3e, Dist %.3e, AllStats.Mean %.3e \n',casestr,max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))
    ...
    PdA=Policy_A(1:l_d,:); PdB=Policy_B(1:l_d,:);
    fprintf('CrossTest plainvswithA1 (nod1 noz e) [EZ %s]: should be zero: V %.3e, Policy %.3e, Dist %.3e, AllStats.Mean %.3e \n',casestr,max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))
    ...
    PdA=Policy_A(1:l_d,:); PdB=Policy_B(1:l_d,:);
    fprintf('CrossTest plainvswithA1 (nod1 z e) [EZ %s]: should be zero: V %.3e, Policy %.3e, Dist %.3e, AllStats.Mean %.3e \n',casestr,max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))
