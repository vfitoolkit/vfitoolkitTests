function output=EZRiskyAsset_CrossTests_semizasz_d1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (semiz-as-z): RiskyAsset, d1, single asset -- EPSTEIN-ZIN version.
% As EZRiskyAsset_CrossTests_semizasz_nod1 but with a d1 (labour supply h).
...
% Mirrors CoreFHorzRiskyAsset_CrossTests_semizasz_d1 mechanics, run for the three EZ cases.
% TEST-FIRST: the semiz-side solves need the EZ riskyasset d1 semiz raw with n_z=0.
%
% Driver passes the SEMIZ n_d=[n_d1,n_d2,n_d3,n_d4]=[h,riskyshare,savings,dsemiz];
% d_grid=[d1;d2;d3;d4]. The z-side uses just the first three decisions.
...
ReturnFn_z_noe_cons=@(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_s_noe_cons=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_cons=@(h,savings,a,z,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_s_e_cons=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_noe_posU=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_s_noe_posU=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_posU=@(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_s_e_posU=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_noe_negU=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_s_noe_negU=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_negU=@(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_s_e_negU=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
...
simoptions_z=simoptions; simoptions_z.refine_d=[1,1,1]; simoptions_z.d_grid=d_grid_z;
...
n_semiz=2;
simoptions_s=simoptions; simoptions_s.refine_d=[1,1,1,1]; simoptions_s.d_grid=d_grid;
...
for ezcase=1:3
    ...
    jequaloneDist_s=zeros([n_a,n_semiz],'gpuArray'); jequaloneDist_s(1,1)=1;
    ...
    fprintf('CrossTest semizasz (d1 noe) [EZ %s]: should be zero: V %2.8f, Policy(h,riskyshare,savings) %2.8f, Dist %2.8f \n',casestr,max(abs(V_z(:)-V_s(:))),max(abs(Pd_z(:)-Pd_s(:))),max(abs(StationaryDist_z(:)-StationaryDist_s(:))))

    %% (2) with e
    jequaloneDist_z=zeros([n_a,n_z,vfoptions_z_e.n_e],'gpuArray'); jequaloneDist_z(1,1,ceil(vfoptions_z_e.n_e/2))=1;
    jequaloneDist_s=zeros([n_a,n_semiz,vfoptions_s_e.n_e],'gpuArray'); jequaloneDist_s(1,1,ceil(vfoptions_s_e.n_e/2))=1;
    ...
    Pd_z=Policy_z(1:3,:); Pd_s=Policy_s(1:3,:);
    fprintf('CrossTest semizasz (d1 e) [EZ %s]: should be zero: V %2.8f, Policy(h,riskyshare,savings) %2.8f, Dist %2.8f \n',casestr,max(abs(V_z(:)-V_s(:))),max(abs(Pd_z(:)-Pd_s(:))),max(abs(StationaryDist_z(:)-StationaryDist_s(:))))
