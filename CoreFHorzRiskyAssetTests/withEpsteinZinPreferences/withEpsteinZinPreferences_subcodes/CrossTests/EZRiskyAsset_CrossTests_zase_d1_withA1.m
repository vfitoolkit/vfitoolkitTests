function output=EZRiskyAsset_CrossTests_zase_d1_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (z-as-e): RiskyAsset, d1, nosemiz, WITH a1 -- EPSTEIN-ZIN version.
% As EZRiskyAsset_CrossTests_zase_d1 but with a standard safe asset a1.
% a=[a1,a2]: a1=safe asset (a1prime chosen directly), a2=risky asset (set by aprimeFn).
% n_d=[h,riskyshare,savings]; n_a=[n_a1,n_a2]; a_grid=[a1_grid;a2_grid].
% Mirrors CoreFHorzRiskyAsset_CrossTests_zase_d1_withA1 mechanics, run for the three EZ cases.
...
ReturnFn_none_cons=@(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_z_cons=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,z,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_e_cons=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_ze_cons=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,r_a1,agej,Jr,pension);
ReturnFn_none_posU=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_z_posU=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_e_posU=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_ze_posU=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_none_negU=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_z_negU=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_e_negU=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz_withA1(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
ReturnFn_ze_negU=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension);
