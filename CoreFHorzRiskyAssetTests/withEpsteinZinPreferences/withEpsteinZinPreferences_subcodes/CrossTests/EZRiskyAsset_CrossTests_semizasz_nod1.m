function output=EZRiskyAsset_CrossTests_semizasz_nod1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (semiz-as-z): RiskyAsset, nod1, single asset -- EPSTEIN-ZIN version.
...
% Under EZ this additionally checks the certainty-equivalent is taken over the semiz transitions
% inside the SAME single joint CE (over (u,semizprime,eprime)) as it is over an equivalent
% markov-z -- the semiz analogue of the nested-vs-joint CE test.
% Mirrors CoreFHorzRiskyAsset_CrossTests_semizasz_nod1 mechanics, run for the three EZ cases.
% TEST-FIRST: the semiz-side solves need the EZ riskyasset semiz raw with n_z=0.
%
...
ReturnFn_z_noe_cons=@(savings,a,z,r,w,kappa_j,agej,Jr,pension) EZRiskyReturnFn_cons_nod1_z_noe_nosemiz(savings,a,z,r,w,kappa_j,agej,Jr,pension);
ReturnFn_s_noe_cons=@(savings,dsemiz,a,semiz,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_nod1_noz_noe_semiz(savings,dsemiz,a,semiz,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_cons=@(savings,a,z,e,r,w,kappa_j,agej,Jr,pension) EZRiskyReturnFn_cons_nod1_z_e_nosemiz(savings,a,z,e,r,w,kappa_j,agej,Jr,pension);
ReturnFn_s_e_cons=@(savings,dsemiz,a,semiz,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_nod1_noz_e_semiz(savings,dsemiz,a,semiz,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_noe_posU=@(savings,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_nod1_z_noe_nosemiz(savings,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_s_noe_posU=@(savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_nod1_noz_noe_semiz(savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_posU=@(savings,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_nod1_z_e_nosemiz(savings,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_s_e_posU=@(savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_nod1_noz_e_semiz(savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_noe_negU=@(savings,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_nod1_z_noe_nosemiz(savings,a,z,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_s_noe_negU=@(savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_nod1_noz_noe_semiz(savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_e_negU=@(savings,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_nod1_z_e_nosemiz(savings,a,z,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_s_e_negU=@(savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_nod1_noz_e_semiz(savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost);
