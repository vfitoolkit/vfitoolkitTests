function output=EZRiskyAsset_CrossTests_zase_d1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (z-as-e) WITH a semiz background: RiskyAsset, d1, single asset -- EPSTEIN-ZIN version.
% Same three z-as-e equivalences as EZRiskyAsset_CrossTests_zase_d1, but every model also
...
% Mirrors CoreFHorzRiskyAsset_CrossTests_zase_d1_semiz mechanics, run for the three EZ cases.
...
% TEST-FIRST: EZ riskyasset semiz beyond the single nod1 raw does not exist yet, so every solve
% here is expected to error until the d1 semiz raws are implemented (and n_z=0 legs additionally
% need the noz handling).
...
ReturnFn_none_cons=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_cons=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_e_cons=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_ze_cons=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_none_posU=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_posU=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_e_posU=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_ze_posU=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_none_negU=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_z_negU=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_e_negU=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_ze_negU=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
...
for ezcase=1:3
    ...
    fprintf('CrossTest zase+semiz (A) single-point z == no z [EZ %s], this should be zero: V %.3e, Policy %.3e, Dist %.3e \n',casestr,max(abs(V0(:)-V0z(:))),max(abs(Policy0(:)-Policy0z(:))),max(abs(StationaryDist0(:)-StationaryDist0z(:))))
    ...
    fprintf('CrossTest zase+semiz (B) iid-markov-z == e [EZ %s], this should be zero: V %.3e, Policy %.3e, Dist %.3e \n',casestr,max(abs(V1(:)-V2(:))),max(abs(Policy1(:)-Policy2(:))),max(abs(StationaryDist1(:)-StationaryDist2(:))))
    ...
    fprintf('CrossTest zase+semiz (C) z&e with z=1 [EZ %s], this should be zero: V %.3e, Policy %.3e, Dist %.3e \n',casestr,max(abs(V1(:)-V3(:))),max(abs(Policy1(:)-Policy3(:))),max(abs(StationaryDist1(:)-StationaryDist3(:))))
    ...
    fprintf('CrossTest zase+semiz (C) z&e with e=1 [EZ %s], this should be zero: V %.3e, Policy %.3e, Dist %.3e \n',casestr,max(abs(V1(:)-V4(:))),max(abs(Policy1(:)-Policy4(:))),max(abs(StationaryDist1(:)-StationaryDist4(:))))
