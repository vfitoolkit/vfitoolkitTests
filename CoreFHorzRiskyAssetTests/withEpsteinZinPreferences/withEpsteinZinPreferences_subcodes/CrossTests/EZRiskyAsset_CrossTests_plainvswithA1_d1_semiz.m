function output=EZRiskyAsset_CrossTests_plainvswithA1_d1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (plain vs degenerate withA1): RiskyAsset, d1, +semiz -- EPSTEIN-ZIN version.
% As EZRiskyAsset_CrossTests_plainvswithA1_nod1_semiz but with a d1 (labour supply h).
...
%   n_d=[n_d1,n_d2,n_d3,n_d4]=[h,riskyshare,savings,dsemiz]; n_a is the single risky asset.
% Only 2 shock blocks: (noz,noe,+semiz) and (noz,e,+semiz).
% Mirrors CoreFHorzRiskyAsset_CrossTests_plainvswithA1_d1_semiz mechanics, for the three EZ cases.
% TEST-FIRST: needs the EZ riskyasset d1 semiz raws (noa1 and withA1) to handle n_z=0.
...
for ezcase=1:3
    ...
    if ezcase==1 % consumption-units (traditional Epstein-Zin)
        ...
        ReturnFn_A_none=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_B_none=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_noe_semiz(h,savings,dsemiz,a2,semiz,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_A_e=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_B_e=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_noz_e_semiz(h,savings,dsemiz,a2,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
    elseif ezcase==2 % utility-units, positive-valued utility fn
        ...
        ReturnFn_A_none=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_B_none=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_noe_semiz(h,savings,dsemiz,a2,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_A_e=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_B_e=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_noz_e_semiz(h,savings,dsemiz,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
    else % utility-units, negative-valued utility fn
        casestr='negative utils';
        vfoptions.EZutils=1;
        vfoptions.EZpositiveutility=0;
        vfoptions.EZriskaversion='ezrisk';
        ReturnFn_A_none=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_B_none=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_noe_semiz(h,savings,dsemiz,a2,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_A_e=@(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
        ReturnFn_B_e=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_noz_e_semiz(h,savings,dsemiz,a2,semiz,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
    end
