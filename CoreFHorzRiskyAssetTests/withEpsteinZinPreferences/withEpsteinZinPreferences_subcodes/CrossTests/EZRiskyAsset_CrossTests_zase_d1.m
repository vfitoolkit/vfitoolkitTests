function output=EZRiskyAsset_CrossTests_zase_d1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (z-as-e): RiskyAsset, d1, nosemiz, single asset -- EPSTEIN-ZIN version.
% As EZRiskyAsset_CrossTests_zase_nod1 but with a d1 (labour supply h). n_d=[h,riskyshare,savings].
% Mirrors CoreFHorzRiskyAsset_CrossTests_zase_d1 mechanics, run for the three EZ cases.
...
ReturnFn_none_cons=@(h,savings,a,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_z_cons=@(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_e_cons=@(h,savings,a,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_ze_cons=@(h,savings,a,z,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_none_posU=@(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_z_posU=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_e_posU=@(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_ze_posU=@(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_none_negU=@(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_z_negU=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_e_negU=@(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_ze_negU=@(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
...
for ezcase=1:3
    ...
    fprintf('CrossTest zase (A) single-point z == no z [EZ %s], this should be zero: V %2.8f, Policy %2.8f, Dist %2.8f \n',casestr,max(abs(V0(:)-V0z(:))),max(abs(Policy0(:)-Policy0z(:))),max(abs(StationaryDist0(:)-StationaryDist0z(:))))
    ...
    fprintf('CrossTest zase (B) iid-markov-z == e [EZ %s], this should be zero: V %2.8f, Policy %2.8f, Dist %2.8f \n',casestr,max(abs(V1(:)-V2(:))),max(abs(Policy1(:)-Policy2(:))),max(abs(StationaryDist1(:)-StationaryDist2(:))))
    ...
    fprintf('CrossTest zase (C) z&e with z=1 [EZ %s], this should be zero: V %2.8f, Policy %2.8f, Dist %2.8f \n',casestr,max(abs(V1(:)-V3(:))),max(abs(Policy1(:)-Policy3(:))),max(abs(StationaryDist1(:)-StationaryDist3(:))))
    ...
    fprintf('CrossTest zase (C) z&e with e=1 [EZ %s], this should be zero: V %2.8f, Policy %2.8f, Dist %2.8f \n',casestr,max(abs(V1(:)-V4(:))),max(abs(Policy1(:)-Policy4(:))),max(abs(StationaryDist1(:)-StationaryDist4(:))))
