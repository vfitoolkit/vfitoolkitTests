function output=EZRiskyAsset_CrossTests_zase_nod1_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (z-as-e) WITH a semiz background: RiskyAsset, nod1, WITH a1 -- EPSTEIN-ZIN version.
% Same three z-as-e equivalences as EZRiskyAsset_CrossTests_zase_nod1_semiz, but with a standard
...
% Mirrors CoreFHorzRiskyAsset_CrossTests_zase_nod1_semiz_withA1 mechanics, for the three EZ cases.
...
ReturnFn_none_cons=@(savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_nod1_noz_noe_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
...
ReturnFn_ze_cons=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_none_posU=@(savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_nod1_noz_noe_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
...
ReturnFn_ze_posU=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_none_negU=@(savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_nod1_noz_noe_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
...
ReturnFn_ze_negU=@(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_nod1_z_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
