function output=EZRiskyAsset_CrossTests_plainvswithA1_d1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (plain vs degenerate withA1): RiskyAsset, d1, nosemiz -- EPSTEIN-ZIN version.
% As EZRiskyAsset_CrossTests_plainvswithA1_nod1 but with a d1 (labour supply h).
% Side A: plain single-asset riskyasset. Side B: withA1 riskyasset with n_a1=1 (degenerate).
...
% n_d=[h,riskyshare,savings]; n_a is scalar (the risky asset); a_grid is its grid.
% Mirrors CoreFHorzRiskyAsset_CrossTests_plainvswithA1_d1 mechanics, for the three EZ cases.
...
for ezcase=1:3
    ...
    if ezcase==1 % consumption-units (traditional Epstein-Zin)
        ...
        ReturnFn_A_none=@(h,savings,a,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_B_none=@(h,savings,a1prime,a1,a2,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_noe_nosemiz(h,savings,a2,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_A_z=@(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_B_z=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a2,z,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_A_e=@(h,savings,a,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_B_e=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_noz_e_nosemiz(h,savings,a2,e,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_A_ze=@(h,savings,a,z,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,varphi,agej,Jr,pension);
        ReturnFn_B_ze=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_e_nosemiz(h,savings,a2,z,e,r,w,kappa_j,varphi,agej,Jr,pension);
    elseif ezcase==2 % utility-units, positive-valued utility fn
        ...
        ReturnFn_A_none=@(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_none=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz(h,savings,a2,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_A_z=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_z=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a2,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_A_e=@(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_e=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_noz_e_nosemiz(h,savings,a2,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_A_ze=@(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_ze=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz(h,savings,a2,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
    else % utility-units, negative-valued utility fn
        casestr='negative utils';
        vfoptions.EZutils=1;
        vfoptions.EZpositiveutility=0;
        vfoptions.EZriskaversion='ezrisk';
        ReturnFn_A_none=@(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_none=@(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz(h,savings,a2,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_A_z=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_z=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a2,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_A_e=@(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_e=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_noz_e_nosemiz(h,savings,a2,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_A_ze=@(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
        ReturnFn_B_ze=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_e_nosemiz(h,savings,a2,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
    end
    ...
    FnsA.assets=@(h,riskyshare,savings,a) a; FnsB.assets=@(h,riskyshare,savings,a1prime,a1,a2) a2;
    ...
    FnsA.assets=@(h,riskyshare,savings,a,z) a; FnsB.assets=@(h,riskyshare,savings,a1prime,a1,a2,z) a2;
    ...
    FnsA.assets=@(h,riskyshare,savings,a,e) a; FnsB.assets=@(h,riskyshare,savings,a1prime,a1,a2,e) a2;
    ...
    FnsA.assets=@(h,riskyshare,savings,a,z,e) a; FnsB.assets=@(h,riskyshare,savings,a1prime,a1,a2,z,e) a2;
