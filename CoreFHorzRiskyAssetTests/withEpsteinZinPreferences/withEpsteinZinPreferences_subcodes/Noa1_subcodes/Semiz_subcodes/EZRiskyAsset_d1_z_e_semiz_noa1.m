function output=EZRiskyAsset_d1_z_e_semiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of CoreFHorzRiskyAsset_d1_z_e_semiz_noa1.m. The model is run three times:
...
ReturnFn_cons=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_posU=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_negU=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.assets=@(h,riskyshare,savings,dsemiz,a,semiz,z,e) a;
FnsToEvaluate.savings=@(h,riskyshare,savings,dsemiz,a,semiz,z,e) savings;
FnsToEvaluate.hours=@(h,riskyshare,savings,dsemiz,a,semiz,z,e) h;
FnsToEvaluate.earnings=@(h,riskyshare,savings,dsemiz,a,semiz,z,e,w,kappa_j) w*kappa_j*h*z*e*semiz;
...
title('EZ cons-units, age-cond mean: assets / savings (d1+semiz+z+e)')
...
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('EZ positive utils, age-cond mean: assets / savings (d1+semiz+z+e)')
legend('assets','savings')
subplot(2,1,2); plot(1:1:N_j, AgeConditionalStats1.hours.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
...
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('EZ negative utils, age-cond mean: assets / savings (d1+semiz+z+e)')
legend('assets','savings')
subplot(2,1,2); plot(1:1:N_j, AgeConditionalStats1.hours.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
...
% consumption-units
ReturnFn_cons_scaled=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
% legs are the basic solve plus its lowmemory rungs (lowmemory=1,2,3, mirroring the basic-solve
...
for ezcase=1:3
    ...
    % n_u/u_grid/pi_u), semiz settings (n_semiz/semiz_grid/SemiExoStateFn) and e settings
    % (n_e/e_grid/pi_e); the EZ fields left on it by Case 3 are all overwritten below (EZeis and
    % EZpositiveutility are only ever read under the matching EZutils setting)
    ...
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=1 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=1 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=2;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=2 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=2 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=3;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1, lowmemory=3 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1, lowmemory=3 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Policybase(:)-Policyshort(:))))
...
%  (vi).4 cross-method with sj: basic==lowmemory=1,2,3, FromPolicy==V (all three EZ cases; the
...
for ezcase=1:3
    vfoptionsv=vfoptions; % inherits ALL the baseline riskyasset, semiz and e settings (see the note in (v));
...
V1btransformed=((1-Params.ezgamma)*V1b).^(1/(1-Params.ezgamma));
fprintf('EZ gamma=1/phi collapse with sj, Policy: should give zero: %.3e \n',max(abs(Policy1a(:)-Policy1b(:))))
...
fprintf('EZ (positive utils) with EZriskaversion=0 and sj: should give zero: %.3e \n',max(abs(V2a(:)-V2b(:))))
fprintf('EZ (positive utils) with EZriskaversion=0 and sj: should give zero: %.3e \n',max(abs(Policy2a(:)-Policy2b(:))))
% negative-valued utility fn
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
...
fprintf('EZ (negative utils) with EZriskaversion=0 and sj: should give zero: %.3e \n',max(abs(V3a(:)-V3b(:))))
fprintf('EZ (negative utils) with EZriskaversion=0 and sj: should give zero: %.3e \n',max(abs(Policy3a(:)-Policy3b(:))))
Params.ezrisk=ezrisk_store;
clear V2a V2b V3a V3b Policy2a Policy2b Policy3a Policy3b

% (vi).4 cross-method with survival probabilities: basic==lowmemory=1,2,3, FromPolicy==V
for ezcase=1:3
    vfoptionsv=vfoptions; % inherits ALL the baseline riskyasset, semiz and e settings (see the note in (v));
    % the EZ fields left on it by earlier sections are all overwritten below
    vfoptionsv.exoticpreferences='EpsteinZin';
    ...
    fprintf('lowmemory=1 with sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=1 with sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=2;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=2 with sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=2 with sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=3;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=3 with sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=3 with sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
...
%          here): basic==lowmemory=1,2,3, FromPolicy==V; and identical to the explicit
%          survivalprobability='sjterm' with sjterm=[ones(1,N_j-1),0].
%  (vii).2 warm-glow with declining sj: basic==lowmemory=1,2,3, FromPolicy==V.
...
for ezcase=1:3
    ...
    vfoptionsv.lowmemory=1;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=1 with terminal warm-glow [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=1 with terminal warm-glow [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=2;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=2 with terminal warm-glow [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=2 with terminal warm-glow [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=3;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=3 with terminal warm-glow [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=3 with terminal warm-glow [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=0;
    V1fromPolicy=ValueFnFromPolicy_FHorz(Policy1,n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,vfoptionsv);
...
for ezcase=1:3
    ...
    vfoptionsv.lowmemory=3;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=3 with warm-glow and sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=3 with warm-glow and sj [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=0;
    V1fromPolicy=ValueFnFromPolicy_FHorz(Policy1,n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,vfoptionsv);
...
for ezcase=1:3
    ...
    vfoptionsjs.lowmemory=1;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1 with sj and warm-glow, lowmemory=1 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1 with sj and warm-glow, lowmemory=1 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=2;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1 with sj and warm-glow, lowmemory=2 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1 with sj and warm-glow, lowmemory=2 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=3;
    [Vshort,Policyshort]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,Njs,d_grid,a_grid,z_grid,pi_z,ReturnFn,Paramsjs,DiscountFactorParamNames,[],vfoptionsjs);
    fprintf('V_Jplus1 with sj and warm-glow, lowmemory=3 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Vbase(:)-Vshort(:))))
    fprintf('V_Jplus1 with sj and warm-glow, lowmemory=3 (jstar=%i) [EZ %s], this should be zero: %.3e \n',jstar,casestr,max(abs(Policybase(:)-Policyshort(:))))
    vfoptionsjs.lowmemory=0;
end
clear Vfull Vbase Vshort Policyfull Policybase Policyshort
...
% is c=pension+a-savings, independent of the semiz state and the z and e states; V_Nj is attained at
% savings=0 (d3_grid(1)=0, consume everything) and search effort dsemiz=0 (d4_grid(1)=0
% maximizes the (1-searcheffortcost*dsemiz) factor) and labour h=0 (d1_grid(1)=0 maximizes
% the (1-h)^(1-varphi) factor), while riskyshare does not enter the return fn, so the
% terminal composite is x=(pension+a)^varphi, giving
%   cons-units: V_Nj(a)=(pension+a)^varphi (the composite good itself: (ezc1*F^ezc2)^ezc7=F for ezc1=1)
%   positive utils: V_Nj(a)=((1+(pension+a)^varphi)^(1-ezsigma)-1)/(1-ezsigma)
%   negative utils: V_Nj(a)=(((pension+a)^varphi)^(1-ezsigma))/(1-ezsigma)
% all independent of the shocks, so the joint certainty-equivalent over (u,semizprime,zprime,eprime) reduces
...
vfoptions1nj.WarmGlowBequestsFn=@(aprime,pension,varphi) (pension+aprime)^varphi;
...
Policyfull=Policyfull(:,:,:,:,:,1:N_j-1);
vfoptions1nj=vfoptions1;
vfoptions1nj.WarmGlowBequestsFn=@(aprime,pension,ezsigma,varphi) ((1+(pension+aprime)^varphi)^(1-ezsigma)-1)/(1-ezsigma);
...
Policyfull=Policyfull(:,:,:,:,:,1:N_j-1);
vfoptions1nj=vfoptions1;
vfoptions1nj.WarmGlowBequestsFn=@(aprime,pension,ezsigma,varphi) (((pension+aprime)^varphi)^(1-ezsigma))/(1-ezsigma);
...
%  (viii).2 distinct mortality risk aversion (ezmrisk=5): basic==lowmemory=1,2,3, FromPolicy==V.
...
for ezcase=1:3
    ...
    vfoptionsv.lowmemory=1;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=1 with sj and mortality risk aversion [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=1 with sj and mortality risk aversion [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=2;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=2 with sj and mortality risk aversion [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=2 with sj and mortality risk aversion [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=3;
    [V2,Policy2]=ValueFnIter_Case1_FHorz(n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,[],vfoptionsv);
    fprintf('lowmemory=3 with sj and mortality risk aversion [EZ %s], this should be zero: %.3e \n',casestr,max(abs(V1(:)-V2(:))))
    fprintf('lowmemory=3 with sj and mortality risk aversion [EZ %s], this should be zero: %.3e \n',casestr,max(abs(Policy1(:)-Policy2(:))))
    vfoptionsv.lowmemory=0;
    V1fromPolicy=ValueFnFromPolicy_FHorz(Policy1,n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid,pi_z,ReturnFn,Params,DiscountFactorParamNames,vfoptionsv);
...
% consumption-units
ReturnFn_cons_scaled2=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
fprintf('EZoneminusbeta=2 with sj (cons-units) vs manual scaling: should give zero: %.3e \n',max(abs(V4a(:)-V4b(:))))
fprintf('EZoneminusbeta=2 with sj (cons-units) vs manual scaling: should give zero: %.3e \n',max(abs(Policy4a(:)-Policy4b(:))))

% utility-units, positive
ReturnFn_posU_scaled2=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
fprintf('EZoneminusbeta=2 with sj (positive utils) vs manual scaling: should give zero: %.3e \n',max(abs(V5a(:)-V5b(:))))
fprintf('EZoneminusbeta=2 with sj (positive utils) vs manual scaling: should give zero: %.3e \n',max(abs(Policy5a(:)-Policy5b(:))))

% utility-units, negative
ReturnFn_negU_scaled2=@(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_d1_z_e_semiz(h,savings,dsemiz,a,semiz,z,e,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
fprintf('EZoneminusbeta=2 with sj (negative utils) vs manual scaling: should give zero: %.3e \n',max(abs(V6a(:)-V6b(:))))
fprintf('EZoneminusbeta=2 with sj (negative utils) vs manual scaling: should give zero: %.3e \n',max(abs(Policy6a(:)-Policy6b(:))))
