function output=EZRiskyAsset_d1_z_noe_semiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of CoreFHorzRiskyAsset_d1_z_noe_semiz_noa1.m. The model is run three times:
...
% ONE joint CE over (u, semizprime, zprime) — the gamma=1/phi collapse only holds exactly
...
ReturnFn_cons=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_cons_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_posU=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_positiveUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_negU=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) EZRiskyReturnFn_negativeUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.assets=@(h,riskyshare,savings,dsemiz,a,semiz,z) a;
FnsToEvaluate.savings=@(h,riskyshare,savings,dsemiz,a,semiz,z) savings;
FnsToEvaluate.hours=@(h,riskyshare,savings,dsemiz,a,semiz,z) h;
FnsToEvaluate.earnings=@(h,riskyshare,savings,dsemiz,a,semiz,z,w,kappa_j) w*kappa_j*h*z*semiz;
...
title('EZ cons-units, age-cond mean: assets / savings (d1+semiz+z)')
...
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('EZ positive utils, age-cond mean: assets / savings (d1+semiz+z)')
legend('assets','savings')
subplot(2,1,2); plot(1:1:N_j, AgeConditionalStats1.hours.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
...
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('EZ negative utils, age-cond mean: assets / savings (d1+semiz+z)')
legend('assets','savings')
subplot(2,1,2); plot(1:1:N_j, AgeConditionalStats1.hours.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
...
% consumption-units
ReturnFn_cons_scaled=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
% is c=pension+a-savings, independent of the semiz state and the z state; V_Nj is attained at
...
% all independent of the shocks, so the joint certainty-equivalent over (u,semizprime,zprime) reduces
...
% consumption-units
ReturnFn_cons_scaled2=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
