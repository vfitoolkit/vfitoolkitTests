function output=EZRiskyAsset_nod1_noz_e_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of CoreFHorzRiskyAsset_nod1_noz_e_nosemiz_noa1.m. The model is run three times:
...
ReturnFn_cons=@(savings,a,e,r,w,kappa_j,agej,Jr,pension) EZRiskyReturnFn_cons_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,agej,Jr,pension);
ReturnFn_posU=@(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
ReturnFn_negU=@(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.assets=@(riskyshare,savings,a,e) a;
FnsToEvaluate.savings=@(riskyshare,savings,a,e) savings;
FnsToEvaluate.earnings=@(riskyshare,savings,a,e,w,kappa_j) w*kappa_j*e;
...
title('EZ cons-units, age-cond mean: assets / savings / earnings (e)')
...
plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
title('EZ positive utils, age-cond mean: assets / savings / earnings (e)')
legend('assets','savings','earnings')
...
plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
title('EZ negative utils, age-cond mean: assets / savings / earnings (e)')
legend('assets','savings','earnings')
...
% consumption-units
ReturnFn_cons_scaled=@(savings,a,e,r,w,kappa_j,agej,Jr,pension,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
% consumption-units
ReturnFn_cons_scaled2=@(savings,a,e,r,w,kappa_j,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz(savings,a,e,r,w,kappa_j,ezsigma,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
