function output=EZRiskyAsset_d1_z_noe_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% Epstein-Zin mirror of CoreFHorzRiskyAsset_d1_z_noe_nosemiz_noa1.m. The model is run three times:
...
% ONE joint CE over (u, zprime) — the gamma=1/phi collapse only holds exactly if the
...
ReturnFn_cons=@(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension) EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
ReturnFn_posU=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
ReturnFn_negU=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension) EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.assets=@(h,riskyshare,savings,a,z) a;
FnsToEvaluate.savings=@(h,riskyshare,savings,a,z) savings;
FnsToEvaluate.hours=@(h,riskyshare,savings,a,z) h;
FnsToEvaluate.earnings=@(h,riskyshare,savings,a,z,w,kappa_j) w*kappa_j*h*z;
...
title('EZ cons-units, age-cond mean: assets / savings (d1+z)')
...
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('EZ positive utils, age-cond mean: assets / savings (d1+z)')
legend('assets','savings')
subplot(2,1,2); plot(1:1:N_j, AgeConditionalStats1.hours.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
...
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('EZ negative utils, age-cond mean: assets / savings (d1+z)')
legend('assets','savings')
subplot(2,1,2); plot(1:1:N_j, AgeConditionalStats1.hours.Mean, 1:1:N_j, AgeConditionalStats1.earnings.Mean)
...
% consumption-units
ReturnFn_cons_scaled=@(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension,ezscalefactor) ezscalefactor*EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
ReturnFn_posU_scaled=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
ReturnFn_negU_scaled=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru) ezscalefactoru*EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
...
% consumption-units
ReturnFn_cons_scaled2=@(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension,ezscalefactor2) ezscalefactor2*EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=0;
vfoptions1.EZriskaversion='ezgamma';
...
% utility-units, positive
ReturnFn_posU_scaled2=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_positiveUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=1;
...
% utility-units, negative
ReturnFn_negU_scaled2=@(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,ezscalefactoru2) ezscalefactoru2*EZRiskyReturnFn_negativeUtils_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension);
vfoptions1=vfoptions;
vfoptions1.exoticpreferences='EpsteinZin';
vfoptions1.EZutils=1;
vfoptions1.EZpositiveutility=0;
