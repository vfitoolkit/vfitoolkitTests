function F=EZRiskyReturnFn_positiveUtils_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension)
% RiskyAsset, with d1 (h=labour), no z, no e, no semiz. UTILITY-UNITS Epstein-Zin, POSITIVE-valued utility fn
