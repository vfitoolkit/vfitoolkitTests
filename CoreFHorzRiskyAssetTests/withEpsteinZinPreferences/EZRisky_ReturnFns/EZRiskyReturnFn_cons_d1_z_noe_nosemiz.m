function F=EZRiskyReturnFn_cons_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,varphi,agej,Jr,pension)
% RiskyAsset, with d1 (h=labour), z, no e, no semiz. CONSUMPTION-UNITS Epstein-Zin (vfoptions.EZutils=0):
