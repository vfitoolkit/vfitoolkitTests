function F=EZRiskyReturnFn_cons_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,varphi,agej,Jr,pension)
% RiskyAsset, with d1 (h=labour), no z, e, no semiz. CONSUMPTION-UNITS Epstein-Zin (vfoptions.EZutils=0):
