function F=EZRiskyReturnFn_negativeUtils_d1_noz_noe_nosemiz_withA1(h,savings,a1prime,a1,a2,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) %#ok<INUSD>
% RiskyAsset with a1 (safe, earns r_a1) + a2 (risky, return realised via aprimeFn); d1, no z, no e, no semiz.
...
if agej<Jr
    c=w*kappa_j*h + (1+r_a1)*a1 + a2 - a1prime - savings;
else
