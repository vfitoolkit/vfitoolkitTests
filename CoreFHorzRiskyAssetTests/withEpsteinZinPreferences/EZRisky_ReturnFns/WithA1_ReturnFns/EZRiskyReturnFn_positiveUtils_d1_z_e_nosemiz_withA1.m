function F=EZRiskyReturnFn_positiveUtils_d1_z_e_nosemiz_withA1(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,ezsigma,varphi,r_a1,agej,Jr,pension) %#ok<INUSD>
% RiskyAsset with a1 (safe, earns r_a1) + a2 (risky, return realised via aprimeFn); d1, z, e, no semiz.
...
if agej<Jr
    c=w*kappa_j*h*z*e + (1+r_a1)*a1 + a2 - a1prime - savings;
else
