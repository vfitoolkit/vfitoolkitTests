function F=EZRiskyReturnFn_negativeUtils_nod1_z_noe_nosemiz_withA1(savings,a1prime,a1,a2,z,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension) %#ok<INUSD>
% RiskyAsset with a1 (safe, earns r_a1) + a2 (risky, return realised via aprimeFn); no d1, z, no e, no semiz.
...
if agej<Jr
    c=w*kappa_j*z + (1+r_a1)*a1 + a2 - a1prime - savings;
else
