function F=EZRiskyReturnFn_cons_d1_noz_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) %#ok<INUSD>
