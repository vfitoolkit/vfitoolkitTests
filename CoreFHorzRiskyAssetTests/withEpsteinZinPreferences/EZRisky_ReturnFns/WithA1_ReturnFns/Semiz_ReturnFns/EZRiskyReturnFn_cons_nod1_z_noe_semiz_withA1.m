function F=EZRiskyReturnFn_cons_nod1_z_noe_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,r,w,kappa_j,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) %#ok<INUSD>
