function F=EZRiskyReturnFn_positiveUtils_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) %#ok<INUSD>
% RiskyAsset with a1 (standard safe asset, earns r_a1) + a2 (risky asset; risky return
% realised via aprimeFn), and semi-exogenous shock semiz. Variant: nod1_noz_e_semiz.
...
if agej<Jr
    c=w*kappa_j*e*semiz + uempbenefit*(1-semiz) + (1+r_a1)*a1 + a2 - a1prime - savings;
else
