function F=EZRiskyReturnFn_negativeUtils_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,ezsigma,r_a1,agej,Jr,pension) %#ok<INUSD>
% RiskyAsset with a1 (safe, earns r_a1) + a2 (risky, return realised via aprimeFn); no d1, no z, e, no semiz.
...
if agej<Jr
    c=w*kappa_j*e + (1+r_a1)*a1 + a2 - a1prime - savings;
else
