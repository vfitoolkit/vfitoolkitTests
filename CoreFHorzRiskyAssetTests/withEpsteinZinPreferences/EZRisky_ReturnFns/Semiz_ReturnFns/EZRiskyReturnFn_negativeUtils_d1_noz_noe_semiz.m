function F=EZRiskyReturnFn_negativeUtils_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,varphi,agej,Jr,pension,uempbenefit,searcheffortcost)
% RiskyAsset + semiz, with d1 (h=labour), no z, no e. UTILITY-UNITS Epstein-Zin, NEGATIVE-valued utility fn
