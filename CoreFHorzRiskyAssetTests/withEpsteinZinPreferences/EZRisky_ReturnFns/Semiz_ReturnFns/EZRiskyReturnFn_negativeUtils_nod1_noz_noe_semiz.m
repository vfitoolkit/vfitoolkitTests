function F=EZRiskyReturnFn_negativeUtils_nod1_noz_noe_semiz(savings,dsemiz,a,semiz,r,w,kappa_j,ezsigma,agej,Jr,pension,uempbenefit,searcheffortcost)
% RiskyAsset + semiz, no d1, no z, no e. UTILITY-UNITS Epstein-Zin, NEGATIVE-valued utility fn
