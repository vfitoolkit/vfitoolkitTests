function F=EZRiskyReturnFn_cons_d1_noz_e_semiz(h,savings,dsemiz,a,semiz,e,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost)
% RiskyAsset + semiz, with d1 (h=labour), no z, e. CONSUMPTION-UNITS Epstein-Zin (vfoptions.EZutils=0):
