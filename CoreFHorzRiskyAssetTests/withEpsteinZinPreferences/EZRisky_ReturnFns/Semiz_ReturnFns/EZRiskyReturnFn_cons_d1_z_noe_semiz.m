function F=EZRiskyReturnFn_cons_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,varphi,agej,Jr,pension,uempbenefit,searcheffortcost)
% RiskyAsset + semiz, with d1 (h=labour), z, no e. CONSUMPTION-UNITS Epstein-Zin (vfoptions.EZutils=0):
