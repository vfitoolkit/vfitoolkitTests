function F=EZRiskyReturnFn_cons_nod1_z_noe_semiz(savings,dsemiz,a,semiz,z,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost)
% RiskyAsset + semiz, no d1, z, no e. CONSUMPTION-UNITS Epstein-Zin (vfoptions.EZutils=0):
