function F=EZRiskyReturnFn_cons_nod1_noz_e_semiz(savings,dsemiz,a,semiz,e,r,w,kappa_j,agej,Jr,pension,uempbenefit,searcheffortcost)
% RiskyAsset + semiz, no d1, no z, e. CONSUMPTION-UNITS Epstein-Zin (vfoptions.EZutils=0):
