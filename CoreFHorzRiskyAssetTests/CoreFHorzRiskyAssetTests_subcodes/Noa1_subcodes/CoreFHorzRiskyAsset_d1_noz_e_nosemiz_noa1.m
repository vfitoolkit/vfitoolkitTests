function output=CoreFHorzRiskyAsset_d1_noz_e_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset, with d1 (labour), no z, e.
...
ReturnFn=@(h,savings,a,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
...
title('Age-conditional mean: assets / savings (d1+e)')
...
% and the terminal V_Jplus1 branch, are also covered), each with the same lowmemory rungs as above.
