function output=CoreFHorzRiskyAsset_d1_noz_noe_semiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset + semiz, with d1 (labour), no z, no e.
...
ReturnFn=@(h,savings,dsemiz,a,semiz,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_noe_semiz(h,savings,dsemiz,a,semiz,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
...
fprintf('Age-conditional assets.Mean / hours.Mean:\n')
[AgeConditionalStats1.assets.Mean; AgeConditionalStats1.hours.Mean]

%% Graph
fig=figure(figure_c);
subplot(2,1,1); plot(1:1:N_j, AgeConditionalStats1.assets.Mean, 1:1:N_j, AgeConditionalStats1.savings.Mean)
title('Age-conditional mean: assets / savings (with d1+semiz)')
