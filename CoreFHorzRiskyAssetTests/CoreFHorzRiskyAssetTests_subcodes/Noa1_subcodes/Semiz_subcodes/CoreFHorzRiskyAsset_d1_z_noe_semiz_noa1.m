function output=CoreFHorzRiskyAsset_d1_z_noe_semiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset + semiz, with d1 (labour), z, no e.
...
ReturnFn=@(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_z_noe_semiz(h,savings,dsemiz,a,semiz,z,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension,uempbenefit,searcheffortcost);
...
title('Age-conditional mean: assets / savings (d1+semiz+z)')
