function output=CoreFHorzRiskyAsset_nod1_noz_noe_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
FnsToEvaluate.assets=@(savings,dsemiz,a,semiz) a;
FnsToEvaluate.savings=@(savings,dsemiz,a,semiz) savings;
FnsToEvaluate.earnings=@(savings,dsemiz,a,semiz,w,kappa_j) w*kappa_j*semiz;
