...
FnsToEvaluate.assets=@(savings,dsemiz,a,semiz,e) a;
FnsToEvaluate.savings=@(savings,dsemiz,a,semiz,e) savings;
FnsToEvaluate.earnings=@(savings,dsemiz,a,semiz,e,w,kappa_j) w*kappa_j*e*semiz;
