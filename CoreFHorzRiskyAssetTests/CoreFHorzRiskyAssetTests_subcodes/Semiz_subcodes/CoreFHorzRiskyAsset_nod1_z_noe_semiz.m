...
FnsToEvaluate.assets=@(savings,dsemiz,a,semiz,z) a;
FnsToEvaluate.savings=@(savings,dsemiz,a,semiz,z) savings;
FnsToEvaluate.earnings=@(savings,dsemiz,a,semiz,z,w,kappa_j) w*kappa_j*z*semiz;
