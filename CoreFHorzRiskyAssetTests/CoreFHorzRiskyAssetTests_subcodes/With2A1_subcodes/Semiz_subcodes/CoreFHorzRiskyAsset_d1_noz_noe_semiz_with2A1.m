function output=CoreFHorzRiskyAsset_d1_noz_noe_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset, with TWO standard endogenous assets a1_1,a1_2 plus a2 (risky).
% Exercises the DC2A / GI2A / DC2A_GI2A code paths (length(n_a1)>1). Variant: d1_noz_noe_semiz.
...
ReturnFn=@(h,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,r,w,kappa_j,sigma,eta,varphi,r_a1,r_a1_2,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_noe_semiz_with2A1(h,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,r,w,kappa_j,sigma,eta,varphi,r_a1,r_a1_2,agej,Jr,pension,uempbenefit,searcheffortcost);

% With riskyasset, need to include all d in FnsToEvaluate, even if they are not in the ReturnFn
FnsToEvaluate.a1=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz) a1;
FnsToEvaluate.a1_2=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz) a1_2;
FnsToEvaluate.a2=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz) a2;
FnsToEvaluate.savings=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz) savings;
FnsToEvaluate.earnings=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,w,kappa_j) w*kappa_j*h;
...
jequaloneDist5=zeros([n_a,vfoptions.n_semiz],'gpuArray');
jequaloneDist5(1,1,1,ceil(vfoptions.n_semiz/2))=1;
