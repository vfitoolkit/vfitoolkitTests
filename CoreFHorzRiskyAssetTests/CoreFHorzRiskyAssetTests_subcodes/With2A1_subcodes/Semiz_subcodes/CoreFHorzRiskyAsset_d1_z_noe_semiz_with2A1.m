function output=CoreFHorzRiskyAsset_d1_z_noe_semiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset, with TWO standard endogenous assets a1_1,a1_2 plus a2 (risky).
% Exercises the DC2A / GI2A / DC2A_GI2A code paths (length(n_a1)>1). Variant: d1_z_noe_semiz.
...
FnsToEvaluate.a1=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) a1;
FnsToEvaluate.a1_2=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) a1_2;
FnsToEvaluate.a2=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) a2;
FnsToEvaluate.savings=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z) savings;
FnsToEvaluate.earnings=@(h,riskyshare,savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,w,kappa_j) w*kappa_j*h;
...
jequaloneDist5(1,1,1,ceil(vfoptions.n_semiz/2),ceil(n_z/2))=1;
