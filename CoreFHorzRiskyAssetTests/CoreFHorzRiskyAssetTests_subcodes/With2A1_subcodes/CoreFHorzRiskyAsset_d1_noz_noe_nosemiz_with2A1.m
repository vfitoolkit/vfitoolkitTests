function output=CoreFHorzRiskyAsset_d1_noz_noe_nosemiz_with2A1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset, with TWO standard endogenous assets a1_1,a1_2 plus a2 (risky).
% Exercises the DC2A / GI2A / DC2A_GI2A code paths (length(n_a1)>1). Variant: d1_noz_noe_nosemiz.
...
FnsToEvaluate.a1=@(h,riskyshare,savings,a1prime,a1_2prime,a1,a1_2,a2) a1;
FnsToEvaluate.a1_2=@(h,riskyshare,savings,a1prime,a1_2prime,a1,a1_2,a2) a1_2;
FnsToEvaluate.a2=@(h,riskyshare,savings,a1prime,a1_2prime,a1,a1_2,a2) a2;
FnsToEvaluate.savings=@(h,riskyshare,savings,a1prime,a1_2prime,a1,a1_2,a2) savings;
FnsToEvaluate.earnings=@(h,riskyshare,savings,a1prime,a1_2prime,a1,a1_2,a2,w,kappa_j) w*kappa_j*h;
