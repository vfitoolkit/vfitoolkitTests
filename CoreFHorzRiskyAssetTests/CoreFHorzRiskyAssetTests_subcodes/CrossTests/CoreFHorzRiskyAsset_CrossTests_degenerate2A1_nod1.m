function output=CoreFHorzRiskyAsset_CrossTests_degenerate2A1_nod1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test (with2A1, nod1): a DEGENERATE second standard asset a1_2 (single grid point {0})
...
ReturnFn_A=@(savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_z_noe_nosemiz_withA1(savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
vfoptionsA=struct(); vfoptionsA.riskyasset=1; vfoptionsA.refine_d=[0,1,1];
...
ReturnFn_B=@(savings,a1prime,a1_2prime,a1,a1_2,a2,z,r,w,kappa_j,sigma,r_a1,r_a1_2,agej,Jr,pension) ReturnFn_nod1_z_noe_nosemiz_with2A1(savings,a1prime,a1_2prime,a1,a1_2,a2,z,r,w,kappa_j,sigma,r_a1,r_a1_2,agej,Jr,pension);
...
fprintf('Cross test (with2A1, nod1): degenerate a1_2 reduces to with-a1, this should be zero: V %.3e, Dist %.3e \n',max(abs(V_A(:)-V_B(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))))
