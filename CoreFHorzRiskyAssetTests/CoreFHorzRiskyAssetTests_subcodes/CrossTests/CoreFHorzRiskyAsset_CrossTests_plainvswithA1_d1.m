function output=CoreFHorzRiskyAsset_CrossTests_plainvswithA1_d1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest (plain vs degenerate withA1): RiskyAsset, d1, nosemiz.
% As CoreFHorzRiskyAsset_CrossTests_plainvswithA1_nod1 but with a d1 (labour supply h). n_d=[h,riskyshare,savings].
...
%% (1) noz, noe
ReturnFn_A=@(h,savings,a,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_noz_noe_nosemiz(h,savings,a,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
ReturnFn_B=@(h,savings,a1prime,a1,a2,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_noz_noe_nosemiz(h,savings,a2,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
...
fprintf('CrossTest plainvswithA1 (d1 noz noe): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.Mean %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))

%% (2) z, noe
ReturnFn_A=@(h,savings,a,z,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_z_noe_nosemiz(h,savings,a,z,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
ReturnFn_B=@(h,savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_z_noe_nosemiz(h,savings,a2,z,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
...
PdA=Policy_A(1:l_d,:); PdB=Policy_B(1:l_d,:);
fprintf('CrossTest plainvswithA1 (d1 z noe): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.Mean %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))

%% (3) noz, e
ReturnFn_A=@(h,savings,a,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_noz_e_nosemiz(h,savings,a,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
ReturnFn_B=@(h,savings,a1prime,a1,a2,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_noz_e_nosemiz(h,savings,a2,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
...
PdA=Policy_A(1:l_d,:); PdB=Policy_B(1:l_d,:);
fprintf('CrossTest plainvswithA1 (d1 noz e): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.Mean %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))

%% (4) z, e
ReturnFn_A=@(h,savings,a,z,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_z_e_nosemiz(h,savings,a,z,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
ReturnFn_B=@(h,savings,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension) ReturnFn_d1_z_e_nosemiz(h,savings,a2,z,e,r,w,kappa_j,sigma,eta,varphi,agej,Jr,pension);
...
PdA=Policy_A(1:l_d,:); PdB=Policy_B(1:l_d,:);
fprintf('CrossTest plainvswithA1 (d1 z e): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.Mean %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(PdA(:)-PdB(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))),abs(AllStats_A.assets.Mean-AllStats_B.assets.Mean))
