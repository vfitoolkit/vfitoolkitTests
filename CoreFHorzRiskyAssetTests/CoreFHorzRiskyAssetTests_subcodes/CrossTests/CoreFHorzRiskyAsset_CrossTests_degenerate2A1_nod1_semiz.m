function output=CoreFHorzRiskyAsset_CrossTests_degenerate2A1_nod1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% Cross-test (with2A1, nod1_semiz): a DEGENERATE second standard asset a1_2 (single grid point {0})
...
ReturnFn_A=@(savings,dsemiz,a1prime,a1,a2,semiz,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_z_noe_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
vfoptionsA=struct(); vfoptionsA.riskyasset=1; vfoptionsA.refine_d=[0,1,1,1];
...
ReturnFn_B=@(savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,w,kappa_j,sigma,r_a1,r_a1_2,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_z_noe_semiz_with2A1(savings,dsemiz,a1prime,a1_2prime,a1,a1_2,a2,semiz,z,r,w,kappa_j,sigma,r_a1,r_a1_2,agej,Jr,pension,uempbenefit,searcheffortcost);
...
fprintf('Cross test (with2A1, nod1_semiz): degenerate a1_2 reduces to with-a1, this should be zero: V %2.8f, Dist %2.8f \n',max(abs(V_A(:)-V_B(:))),max(abs(StationaryDist_A(:)-StationaryDist_B(:))))
