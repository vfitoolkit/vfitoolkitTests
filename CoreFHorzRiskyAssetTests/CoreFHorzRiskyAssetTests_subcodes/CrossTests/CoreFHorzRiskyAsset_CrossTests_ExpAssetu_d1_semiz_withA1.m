function output=CoreFHorzRiskyAsset_CrossTests_ExpAssetu_d1_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest: RiskyAsset vs degenerate ExperienceAssetu (d1, +semiz, WITH a1).
% As CoreFHorzRiskyAsset_CrossTests_ExpAssetu_nod1_semiz_withA1 but with a d1 (labour supply h).
%   n_d=[n_d1,n_d2,n_d3,n_d4]=[h,riskyshare,savings,dsemiz].
%   R: refine_d=[1,1,1,1].   E: experienceassetu, l_dexperienceassetu=2 (h is d1; trailing dsemiz is the semiz decision).
...
ReturnFn_R=@(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_E=@(h,riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
FnsR.a2=@(h,riskyshare,savings,dsemiz,a1prime,a1,a2,semiz) a2; FnsE.a2=@(h,riskyshare,savings,dsemiz,a1prime,a1,a2,semiz) a2;
...
fprintf('CrossTest ExpAssetu (d1 noz noe, +semiz withA1): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.a2.Mean %2.8f \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
...
ReturnFn_R=@(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_e_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_E=@(h,riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_noz_e_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
FnsR.a2=@(h,riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e) a2; FnsE.a2=@(h,riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e) a2;
...
fprintf('CrossTest ExpAssetu (d1 noz e, +semiz withA1): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.a2.Mean %2.8f \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
