function output=CoreFHorzRiskyAsset_CrossTests_ExpAssetu_nod1_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% CrossTest: RiskyAsset vs degenerate ExperienceAssetu (nod1, nosemiz, WITH a1).
...
%   R: riskyasset, refine_d=[0,1,1].   E: experienceassetu, l_dexperienceassetu=2.
...
ReturnFn_R=@(savings,a1prime,a1,a2,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_noz_noe_nosemiz_withA1(savings,a1prime,a1,a2,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
ReturnFn_E=@(riskyshare,savings,a1prime,a1,a2,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_noz_noe_nosemiz_withA1(savings,a1prime,a1,a2,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
FnsR.a2=@(riskyshare,savings,a1prime,a1,a2) a2; FnsE.a2=@(riskyshare,savings,a1prime,a1,a2) a2;
...
fprintf('CrossTest ExpAssetu (nod1 noz noe, withA1): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.a2.Mean %2.8f \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))

%% (2) z, noe
jequaloneDist=zeros([n_a,n_z],'gpuArray'); jequaloneDist(1,1,ceil(n_z/2))=1;
ReturnFn_R=@(savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_z_noe_nosemiz_withA1(savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
ReturnFn_E=@(riskyshare,savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_z_noe_nosemiz_withA1(savings,a1prime,a1,a2,z,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
FnsR.a2=@(riskyshare,savings,a1prime,a1,a2,z) a2; FnsE.a2=@(riskyshare,savings,a1prime,a1,a2,z) a2;
...
fprintf('CrossTest ExpAssetu (nod1 z noe, withA1): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.a2.Mean %2.8f \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
...
ReturnFn_R=@(savings,a1prime,a1,a2,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
ReturnFn_E=@(riskyshare,savings,a1prime,a1,a2,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_noz_e_nosemiz_withA1(savings,a1prime,a1,a2,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
FnsR.a2=@(riskyshare,savings,a1prime,a1,a2,e) a2; FnsE.a2=@(riskyshare,savings,a1prime,a1,a2,e) a2;
...
fprintf('CrossTest ExpAssetu (nod1 noz e, withA1): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.a2.Mean %2.8f \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))

%% (4) z, e
jequaloneDist=zeros([n_a,n_z,vfoptionsbaseline.n_e],'gpuArray'); jequaloneDist(1,1,ceil(n_z/2),ceil(vfoptionsbaseline.n_e/2))=1;
ReturnFn_R=@(savings,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_z_e_nosemiz_withA1(savings,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
ReturnFn_E=@(riskyshare,savings,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension) ReturnFn_nod1_z_e_nosemiz_withA1(savings,a1prime,a1,a2,z,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension);
FnsR.a2=@(riskyshare,savings,a1prime,a1,a2,z,e) a2; FnsE.a2=@(riskyshare,savings,a1prime,a1,a2,z,e) a2;
...
fprintf('CrossTest ExpAssetu (nod1 z e, withA1): should be zero: V %2.8f, Policy %2.8f, Dist %2.8f, AllStats.a2.Mean %2.8f \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
