...
fprintf('CrossTest ExpAssetu (nod1 z noe, withA1): should be zero: V %.3e, Policy %.3e, Dist %.3e, AllStats.a2.Mean %.3e \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
...
fprintf('CrossTest ExpAssetu (nod1 noz e, withA1): should be zero: V %.3e, Policy %.3e, Dist %.3e, AllStats.a2.Mean %.3e \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
...
fprintf('CrossTest ExpAssetu (nod1 z e, withA1): should be zero: V %.3e, Policy %.3e, Dist %.3e, AllStats.a2.Mean %.3e \n',max(abs(VR(:)-VE(:))),max(abs(PolicyR(:)-PolicyE(:))),max(abs(StationaryDistR(:)-StationaryDistE(:))),abs(AllStatsR.a2.Mean-AllStatsE.a2.Mean))
