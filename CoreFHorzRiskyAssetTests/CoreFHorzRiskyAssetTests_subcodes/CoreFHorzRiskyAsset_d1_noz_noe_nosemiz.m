...
FnsToEvaluate.assets=@(h,savings,a) a;
FnsToEvaluate.savings=@(h,savings,a) savings;
FnsToEvaluate.hours=@(h,savings,a) h;
FnsToEvaluate.earnings=@(h,savings,a,w,kappa_j) w*kappa_j*h;
