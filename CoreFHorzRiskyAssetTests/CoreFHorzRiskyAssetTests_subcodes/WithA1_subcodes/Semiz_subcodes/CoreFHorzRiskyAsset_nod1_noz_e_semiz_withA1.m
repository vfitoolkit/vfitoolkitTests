function output=CoreFHorzRiskyAsset_nod1_noz_e_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset, with a1 + a2 (a1=safe, a2=risky). Variant: nod1_noz_e_semiz.
...
ReturnFn=@(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_noz_e_semiz_withA1(savings,dsemiz,a1prime,a1,a2,semiz,e,r,w,kappa_j,sigma,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);
...
FnsToEvaluate.earnings=@(riskyshare,savings,dsemiz,a1prime,a1,a2,semiz,e,w,kappa_j) w*kappa_j;
