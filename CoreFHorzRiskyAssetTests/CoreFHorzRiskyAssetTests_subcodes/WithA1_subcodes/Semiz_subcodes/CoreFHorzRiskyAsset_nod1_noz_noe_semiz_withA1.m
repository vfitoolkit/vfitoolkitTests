...
FnsToEvaluate.a1=@(savings,dsemiz,a1prime,a1,a2,semiz) a1;
FnsToEvaluate.a2=@(savings,dsemiz,a1prime,a1,a2,semiz) a2;
FnsToEvaluate.savings=@(savings,dsemiz,a1prime,a1,a2,semiz) savings;
FnsToEvaluate.earnings=@(savings,dsemiz,a1prime,a1,a2,semiz,w,kappa_j) w*kappa_j;
