function output=CoreFHorzRiskyAsset_d1_z_noe_semiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% RiskyAsset, with a1 + a2 (a1=safe, a2=risky). Variant: d1_z_noe_semiz.
...
ReturnFn=@(h,savings,dsemiz,a1prime,a1,a2,semiz,z,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_d1_z_noe_semiz_withA1(h,savings,dsemiz,a1prime,a1,a2,semiz,z,r,w,kappa_j,sigma,eta,varphi,r_a1,agej,Jr,pension,uempbenefit,searcheffortcost);

FnsToEvaluate.a1=@(h,savings,dsemiz,a1prime,a1,a2,semiz,z) a1;
FnsToEvaluate.a2=@(h,savings,dsemiz,a1prime,a1,a2,semiz,z) a2;
FnsToEvaluate.savings=@(h,savings,dsemiz,a1prime,a1,a2,semiz,z) savings;
FnsToEvaluate.earnings=@(h,savings,dsemiz,a1prime,a1,a2,semiz,z,w,kappa_j) w*kappa_j*h;
