function F=ReturnFn_d1_z_e_nosemiz_with2A1(h,savings,a1prime,a1_2prime,a1,a1_2,a2,z,e,r,w,kappa_j,sigma,eta,varphi,r_a1,r_a1_2,agej,Jr,pension)
...
% Variant: d1_z_e_nosemiz. a1_1 earns r_a1 and a1_2 earns r_a1_2; a2 enters directly (risky return realised via aprimeFn).

F=-Inf;

if agej<Jr
    c=w*kappa_j*h*z*e + (1+r_a1)*a1 + (1+r_a1_2)*a1_2 + a2 - a1prime - a1_2prime - savings;
else
