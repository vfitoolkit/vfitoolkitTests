function output=CoreFHorzTPathTwoEndo_nod_noz_noe_nosemiz(T,PricePath,ParamPath,n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,transpathoptionsbaseline,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(a1prime,a2prime,a1,a2,r,w,kappa_j,sigma,agej,Jr,pension,phi1,phi2) ReturnFn_nod_noz_noe_nosemiz(a1prime,a2prime,a1,a2,r,w,kappa_j,sigma,agej,Jr,pension,phi1,phi2);
...
Policy_final=ones([2,n_a,N_j],'gpuArray');
Policy_final_GI=ones([4,n_a,N_j],'gpuArray');
% big versions of them
V_final_big=zeros([n_a_big,N_j],'gpuArray');
Policy_final_big=ones([2,n_a_big,N_j],'gpuArray');
Policy_final_big_GI=ones([4,n_a_big,N_j],'gpuArray');
