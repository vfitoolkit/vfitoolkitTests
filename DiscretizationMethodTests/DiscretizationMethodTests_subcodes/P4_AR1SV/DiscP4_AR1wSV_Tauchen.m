function output=DiscP4_AR1wSV_Tauchen(calib,znums,figure_c)
% P4: discretizeAR1wSV_Tauchen
%
...
for x_c=1:nz
    for z_c=1:nz
        ...
        tic;
        [z_grid,pi_z]=discretizeAR1wSV_Tauchen(rho,phi,sigmau,sigmae,xnum,znum,Tauchen_q,opts);
        twarm=toc;
...
xlabel('znum'); ylabel('xnum'); title('discretizeAR1wSV_Tauchen: log10 |excess kurtosis error|','Interpreter','none')
subplot(1,2,2)
